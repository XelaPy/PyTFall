...
class SchemaGenerator(object):
    ...
    def from_json(cls, base_json):
        ...
        jsonschemas["old_style"] = skinfer.merge_schema(skinfer.infer_schema(base_object), jsonschemas["old_style"]) if "old_style" in jsonschemas else skinfer.infer_schema(base_object)
        obj = cls(base_object)
