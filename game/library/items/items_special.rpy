    ...
    menu:
        ...
        "Yes":
            ...
            if hero.level <= 5:
                ...
                $ levels = randint(hero.level*0.6, hero.level+10)
            ...
            if dice(50):
                ...
                menu:
                    "Propose to work for you":
                        ...
                        "Looks like you have new worker."
                    "Leave her be":
                ...
                $ result = run_default_be(enemy_team, slaves=True, background="content/gfx/bg/be/battle_arena_1.jpg", track="random", prebattle=True, death=True)
                if not(result):
                    jump game_over
                else:
