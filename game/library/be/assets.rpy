...
label load_battle_skills:
    ...
    ##### Magic:
        # Fire:
        BE_Action(u"Fire", menu_pos=0, attributes=["magic", "fire"], effect=10, multiplier=1.0, type="all_enemies", mp_cost=10, range=4, desc="Ignites a small plot of land.",
        ...
        BE_Action(u"Fira", menu_pos=0.1, attributes=["magic", "fire"], effect=10, multiplier=1.1, mp_cost=8, range=4, desc="Ignites the air in a limited area.",
                                           attacker_effects = {"gfx": "fire_1", "sfx": "default"},
        ...
        BE_Action(u"Firaga", menu_pos=0.2, attributes=["magic", "fire"], effect=10, multiplier=0.9, mp_cost=12, range=4, piercing=True, desc="Creates liquid fire that envelopes the target, causing massive burns.",
                                           attacker_effects={"gfx": "fire_1", "sfx": "default"},
        ...
        BE_Action(u"Firaja", menu_pos=0.3, attributes=["magic", "fire"], effect=6, multiplier=0.8, mp_cost=15, range=4, type="all_enemies", piercing=True, desc="Creates a rain of fire that hits all enemies.",
                                           attacker_effects={"gfx": "fire_1", "sfx": "default"},
        ...
        P2P_Skill(u"Solar Flash", menu_pos=1, attributes=["magic", "fire"], effect=50, multiplier=1.4, mp_cost=50, range=4,
                                      ...
                                      dodge_effect={"initial_pause": .1})
        BE_Action("Meteor", menu_pos=5, attributes=["magic", "fire"], effect=50, multiplier=1.2, mp_cost=70, range=4, type="all_enemies", desc="Summons flaming fragments of meteor.",
        ...
        # Water:
        BE_Action(u"Water", menu_pos=0, attributes=["magic", "water"], effect=10, multiplier=1.0, mp_cost=10, range=4, type="all_enemies", desc="Crushes targets by bubbles of water.",
        ...
        BE_Action(u"Waterga", menu_pos=0.2, attributes=["magic", "water"], effect=10, multiplier=0.9, mp_cost=12, range=4, desc="A cloud of water droplets at high speed crashes into the target.",
                                           ...
                                           target_damage_effect={"gfx": "battle_bounce", "sfx": None},
                                           target_death_effect={"gfx": "dissolve", "initial_pause": 1.0, "duration": 0.5})
        BE_Action(u"Waterja", menu_pos=0.3, attributes=["magic", "water"], effect=10, multiplier=0.8, mp_cost=15, range=4, type="all_enemies", piercing=True, desc="Strongest common Water attack in use. Creates a powerful burst of water and steam from the ground.",
                                           attacker_effects={"gfx": "water_1", "sfx": "default"},
        ...
        BE_Action(u"Heavy Rain", menu_pos=5, attributes=["magic", "water"], effect=50, multiplier=1.2, mp_cost=70, type="all_enemies", range=6,
                                           ...
                                           target_death_effect={"gfx": "dissolve", "initial_pause": 4.5, "duration": 0.5})
        ATL_ArealSkill(u"Water Blast", menu_pos=9, attributes=["magic", "water", "inevitable"], effect=100, multiplier=1.5, mp_cost=100, piercing=True, range=6, type="all_enemies",
                                                ...
                                                target_death_effect={"gfx": "dissolve", "initial_pause": 1.0, "duration": 0.5})
        # Ice:
        BE_Action(u"Blizzard", menu_pos=0, attributes=["magic", "ice"], effect=10, multiplier=1.0, mp_cost=10, range=4, type="all_enemies", desc="Creates a cloud of sharp ice splinters.",
        ...
        BE_Action(u"Blizzara", menu_pos=0.1, attributes=["magic", "ice"], effect=10, multiplier=1.1, mp_cost=8, range=4, desc="Ice blades grow out of the ground.",
                                           attacker_effects={"gfx": "ice_1", "sfx": "default"},
        ...
        BE_Action(u"Blizzarga", menu_pos=0.2, attributes=["magic", "ice"], effect=10, multiplier=0.9, mp_cost=12, range=4, desc="Freezes the air itself around the target, creating deadly ice blades.",
        ...
        BE_Action(u"Blizzarja", menu_pos=0.3, attributes=["magic", "ice"], effect=10, multiplier=0.9, mp_cost=15, range=4, desc="Quickly draws heat from a small area.",
                                           ...
                                           target_damage_effect={"gfx": "battle_bounce", "sfx": None},
                                           target_death_effect={"gfx": "dissolve", "sfx": None, "initial_pause": 0.6, "duration": 0.3})
        BE_Action("Ice Blast", menu_pos=0.5, attributes=["magic", "ice"], effect=50, multiplier=1.3, mp_cost=30, range=4, piercing=True, type="se", desc="Summons frozen fragments of meteor.", 
                                           attacker_effects={"gfx": "orb", "sfx": "default"},
        ...
        ATL_ArealSkill("Ice Storm", menu_pos=9, attributes=["magic", "ice", "inevitable"], effect=100, multiplier=1.5, mp_cost=100, range=4, type="all_enemies", piercing=True,
                                                ...
                                                target_death_effect={"gfx": "dissolve", "initial_pause": 1.0, "duration": 0.5})
        # Earth:
        BE_Action(u"Stone", menu_pos=0, attributes=["magic", "earth"], effect=10, multiplier=1.0, mp_cost=10, range=4, type="all_enemies", desc="Creates cloud of fragments of hardened clay.",
        ...
        BE_Action(u"Stonera", menu_pos=0.1, attributes=["magic", "earth"], effect=10, multiplier=1.1, mp_cost=8, range=4, desc="Creates a sharp stone spike.",
                                           attacker_effects={"gfx": "earth_1", "sfx": "default"},
        ...
        BE_Action(u"Stonega", menu_pos=0.2, attributes=["magic", "earth"], effect=10, multiplier=0.9, mp_cost=12, range=4, piercing=True, desc="A small amount of magma moves to the surface, spilling on the target.",
                                           attacker_effects={"gfx": "earth_1", "sfx": "default"},
        ...
        BE_Action(u"Stoneja", menu_pos=0.3, attributes=["magic", "earth"], effect=10, multiplier=0.8, mp_cost=15, range=4, piercing=True, type="all_enemies", desc="Small part of the target becomes stone and shatters into a thousand pieces.",
                                           attacker_effects={"gfx": "earth_1", "sfx": "default"},
        ...
        BE_Action(u"Transmutation", menu_pos=1, attributes=["magic", "earth"], effect=50, multiplier=1.4, mp_cost=50, range=4, dodge_effect={"initial_pause": .2},
        ...
        # Air:
        BE_Action(u"Aero", menu_pos=0, attributes=["magic", "air"], effect=10, multiplier=1.0, mp_cost=10, range=4, type="all_enemies", desc="High pressure air cuts through armor and flesh like a hardened blade.",
        ...
        BE_Action(u"Aerora", menu_pos=0.1, attributes=["magic", "air"], effect=10, multiplier=1.1, mp_cost=8, range=4, desc="Causes damage by sand and branches picked up by the wind rather than air itself.",
                                           attacker_effects={"gfx": "air_1", "sfx": "default"},
        ...
        BE_Action(u"Aeroga", menu_pos=0.2, attributes=["magic", "air"], effect=10, multiplier=0.9, mp_cost=12, range=4, desc="Even for those who don't need to breathe instantaneous air pressure drop is dangerous.", piercing=True,
                                           attacker_effects={"gfx": "air_1", "sfx": "default"},
        ...
        BE_Action(u"Aeroja", menu_pos=0.3, attributes=["magic", "air"], effect=10, multiplier=0.8, mp_cost=15, range=4, desc="High pressure air flows cover a small area.", piercing=True, type="all_enemies",
                                           attacker_effects={"gfx": "air_1", "sfx": "default"},
                                           ...
                                           target_damage_effect={"gfx": "battle_bounce", "sfx": None},
                                           target_death_effect={"gfx": "dissolve", "sfx": None, "initial_pause": 1.0, "duration": 0.3})
        BE_Action(u"Pressure", menu_pos=0.5, attributes=["magic", "air"], effect=50, multiplier=1.3, mp_cost=30, range=4, desc="Pumps air from the target, crushing it by external atmospheric pressure.", piercing=True,
                                           ...
                                           target_damage_effect={"gfx": "battle_bounce", "sfx": None},
                                           target_death_effect={"gfx": "dissolve", "sfx": None, "initial_pause": 1.0, "duration": 0.3})
        BE_Action(u"Air Blast", menu_pos=1, attributes=["magic", "air"], effect=50, multiplier=1.4, mp_cost=50, range=4, desc="Pumps air into the target, tearing it from the inside.",
                                           attacker_effects={"gfx": "air_2", "sfx": "default"},
                                           ...
                                           target_damage_effect={"gfx": "battle_bounce", "initial_pause": 1.0},
                                           target_death_effect={"gfx": "dissolve", "sfx": None, "initial_pause": 1.0, "duration": 0.3})
        BE_Action(u"Vortex", menu_pos=2, attributes=["magic", "air"], effect=50, multiplier=1.2, mp_cost=70, range=4, desc="Creates a small, but very powerful sphere of hurricane winds around the target.", type="all_enemies",
                                           attacker_effects={"gfx": "orb", "sfx": "default"},
        ...
        # Electricity:
        BE_Action(u"Thunder", menu_pos=0, attributes=["magic", "electricity"], effect=10, multiplier=1.0, mp_cost=10, range=4, type="all_enemies", desc="Shocks targets with static electricity caused by friction of airborne particles.",
        ...
        BE_Action(u"Thundara", menu_pos=0.1, attributes=["magic", "electricity"], effect=10, multiplier=1.1, mp_cost=8, range=4, desc="Surrounds the target by brief electricity field.",
                                           attacker_effects={"gfx": "electricity_1", "sfx": "default"},
                                           ...
                                           target_damage_effect={"gfx": "battle_bounce"},
                                           target_death_effect={"gfx": "dissolve", "initial_pause": 0.9, "duration": 0.3})
        BE_Action(u"Thundaga", menu_pos=0.2, attributes=["magic", "electricity"], effect=10, multiplier=0.9, mp_cost=12, range=4, desc="Creates a plasma ball of ionized hot air near the target.",
        ...
        BE_Action(u"Thundaja", menu_pos=0.3, attributes=["magic", "electricity"], effect=10, multiplier=0.8, mp_cost=15, range=4, desc="Covers a small area by lightning discharges.",
        ...
        P2P_Skill(u"Ion Blast", menu_pos=0.5, attributes=["magic", "electricity"], effect=50, multiplier=1.3, mp_cost=30, range=4, piercing=True,
                                      ...
                                      dodge_effect={"initial_pause": .1})
        BE_Action(u"Electromagnetism", menu_pos=1, attributes=["magic", "electricity"], menuname="EM", effect=50, multiplier=1.4, mp_cost=50, range=4, desc="Takes control over charged particles inside the target, causing severe internal injuries.",
        ...
        BE_Action(u"Thunderstorm", menu_pos=2, attributes=["magic", "electricity"], menuname="TStorm", effect=50, multiplier=1.2, mp_cost=70, range=4, desc="Covers a small area by numerous high-voltage discharges.",
                                           ...
                                           target_damage_effect={"gfx": "battle_bounce"},
                                           target_death_effect={"gfx": "dissolve", "initial_pause": 1.0, "duration": 0.2})
        P2P_ArealSkill(u"Ion Storm", menu_pos=5, attributes=["magic", "electricity"], effect=50, multiplier=1.1, mp_cost=60, range=4, piercing=True,
        ...
        # Light:
        BE_Action(u"Holy", menu_pos=0, attributes=["magic", "light"], effect=15, multiplier=1.0, mp_cost=12, range=4, type="all_enemies", desc="A flash of light energy burns targets from inside.",
        ...
        BE_Action(u"Holyra", menu_pos=0.1, attributes=["magic", "light"], effect=15, multiplier=1.1, mp_cost=10, range=4, desc="A sphere of light energy burns the target from all sides.",
                                           attacker_effects={"gfx": "light_1", "sfx": "default"},
                                           ...
                                           target_damage_effect={"gfx": "battle_bounce", "sfx": None},
                                           target_death_effect={"gfx": "dissolve", "sfx": None, "initial_pause":0.9, "duration": 0.2})
        BE_Action(u"Holyda", menu_pos=0.2, attributes=["magic", "light"], effect=15, multiplier=0.9, mp_cost=14, range=4, desc="A smallest particle of stellar energy burns the target.",
        ...
        BE_Action(u"Star Light", menu_pos=0.5, attributes=["magic", "light"], effect=60, multiplier=1.3, mp_cost=35, range=4, desc="A powerful and painful flash of star light.",
                                           ...
                                           target_damage_effect={"gfx": "battle_bounce", "initial_pause": 0.3},
                                           target_death_effect={"gfx": "dissolve", "sfx": None, "initial_pause":1.0, "duration": 0.4})
        BE_Action(u"Photon Blade", menu_pos=1, attributes=["magic", "light"], effect=60, multiplier=1.4, mp_cost=55, range=4, desc="Infinitely thin blades of pure light slices target.",
                                           attacker_effects={"gfx": "light_2", "sfx": "default"},
        ...
        # Darkness:
        BE_Action(u"Dark", menu_pos=0, attributes=["magic", "darkness"], effect=15, multiplier=1.0, mp_cost=12, range=4, type="all_enemies", desc="The mere presence of dark energy is dangerous for most creatures.",
