...
init 2 python:
    ...
    # Magic:
    # Fire:
    SimpleMagicalAttack(u"Fire", attributes=['magic', 'fire'], effect=20, multiplier=1.2, type="all_enemies", cost=5, range=4, casting_effects=["fire_1", "default"], gfx='fire_1', zoom=1.5, pause=2.0, td_gfx=[0.1, "shake", 0.9], sfx="content/sfx/sound/be/fire4.mp3",
                                       aim="bc", anchor=(0.5, 1.0), yo=50,
                                       desc="Ignites a small plot of land.")
    SimpleMagicalAttack(u"Fira", attributes=['magic', 'fire'], effect=30, multiplier=1.2, cost=7, range=4, casting_effects=["fire_1", "default"], gfx='fire_2', zoom=1.5, pause=2.0, td_gfx=[0.1, "shake", 1.3], sfx="content/sfx/sound/be/fire4.mp3",
                                       aim="bc", anchor=(0.5, 1.0), yo=40,
                                       desc="Ignites the air in a limited area.")
    SimpleMagicalAttack(u"Firaga", attributes=['magic', 'fire'], effect=25, multiplier=1.2, cost=6, range=4, piercing=True, casting_effects=["fire_2", "default"], gfx='fire_4', zoom=1.5, pause=5.0, td_gfx=[1.3, "shake", 3.2], sfx="content/sfx/sound/be/fire6.mp3",
                                       aim="bc", anchor=(0.5, 1.0), yo=40,
                                       desc="Creates liquid fire that envelopes the target, causing massive burns.")
    SimpleMagicalAttack(u"Firaja", attributes=['magic', 'fire'], effect=10, multiplier=1.2, cost=15, range=4, type="all_enemies", piercing=True, casting_effects=["fire_1", "default"], gfx='fire_3', zoom=1.5, pause=3.5, td_gfx=[0.1, "shake", 2.7], sfx="content/sfx/sound/be/fire5.mp3",
                                       aim="bc", anchor=(0.5, 1.0), yo=40,
    ...
    # Water:
    SimpleMagicalAttack(u"Water", attributes=['magic', 'water'], effect=10, multiplier=1.2, cost=4, range=4, type="all_enemies", casting_effects=["water_1", "default"], gfx='water_1', zoom=1.1, pause=1.5, td_gfx=[0.1, "shake", 1.4], sfx="content/sfx/sound/be/water.mp3",
                                       aim="bc", anchor=(0.5, 1.0), yo=40,
                                       desc="Crushes targets by bubbles of water.")
    SimpleMagicalAttack(u"Watera", attributes=['magic', 'water'], effect=30, multiplier=1.2, cost=7, range=4, casting_effects=["water_1", "default"], gfx='water_2', zoom=1.4, pause=2.0, td_gfx=[0.1, "shake", 1.5], sfx="content/sfx/sound/be/water.mp3",
                                       aim="bc", anchor=(0.5, 1.0), yo=40,
                                       desc="High pressure water jets pierce through the target.")
    SimpleMagicalAttack(u"Waterga", attributes=['magic', 'water'], effect=25, multiplier=1.2, cost=6, range=4, casting_effects=["water_1", "default"], gfx='water_3', zoom=1.5, pause=2.5, td_gfx=[0.1, "shake", 2.0], sfx="content/sfx/sound/be/water2.mp3", piercing=True,
                                       aim="bc", anchor=(0.5, 1.0), yo=40,
                                       desc="A cloud of water droplets at high speed crashes into the target.")
    SimpleMagicalAttack(u"Waterja", attributes=['magic', 'water'], effect=30, multiplier=1.5, cost=8, range=4, casting_effects=["water_2", "default"], gfx='water_4', zoom=1.5, pause=2.25, td_gfx=[0.1, "shake", 2.0], sfx="content/sfx/sound/be/water3.mp3", type="all_enemies", piercing=True,
                                       aim="bc", anchor=(0.5, 1.0), yo=40,
                                       desc="Evaporates some water from targets.")
    SimpleMagicalAttack(u"Geyser", attributes=['magic', 'water'], effect=65, multiplier=1.5, cost=12, range=6, casting_effects=["water_2", "default"], gfx='water_5', zoom=1.9, pause=3.0, td_gfx=[0.5, "shake", 2.5], sfx="content/sfx/sound/be/water6.mp3",
                                       aim="bc", anchor=(0.5, 1.0), yo=60,
                                       desc="A powerful stream of water shoots out of the ground directly beneath the target.")
    SimpleMagicalAttack(u"Last Drop", attributes=['magic', 'water'], effect=50, multiplier=1.5, cost=10, range=6, casting_effects=["water_2", "default"], gfx='water_6', zoom=2.1, pause=5.0, td_gfx=[0.5, "shake", 3], sfx="content/sfx/sound/be/water5.mp3", piercing=True,
                                       aim="bc", anchor=(0.5, 1.0), yo=60,
                                       desc="Evaporates a great deal of water from the target.")
    SimpleMagicalAttack(u"Heavy Rain", attributes=['magic', 'water'], effect=70, multiplier=1.8, true_pierce=True, cost=15, range=6, casting_effects=["water_2", "default"], gfx='rain', zoom=2.0, pause=5.0, td_gfx=[0.25, "shake", 4.75], sfx="content/sfx/sound/be/heavy_rain.mp3", type="all_enemies", piercing=True,
    ...
    SimpleMagicalAttack(u"Blizzard", attributes=['magic', 'ice'], effect=20, multiplier=1.2, cost=5, range=4, casting_effects=["ice_1", "default"], gfx='ice_1', zoom=1.9, pause=2.9, td_gfx=[0.2, "shake", 1.8], sfx="content/sfx/sound/be/ice3.mp3", type="all_enemies",
                                       aim="bc", anchor=(0.5, 1.0), yo=60,
                                       desc="Creates a cloud of sharp ice splinters.")
    SimpleMagicalAttack(u"Blizzara", attributes=['magic', 'ice'], effect=30, multiplier=1.2, cost=7, range=4, casting_effects=["ice_1", "default"], gfx='ice_2', zoom=1.3, pause=1.5, td_gfx=[0.1, "shake", 1.55], sfx="content/sfx/sound/be/ice1.mp3",
                                       aim="bc", anchor=(0.5, 1.0), yo=80,
                                       desc="Ice blades grow out of the ground.")
    SimpleMagicalAttack(u"Blizzarga", attributes=['magic', 'ice'], effect=25, multiplier=1.2, cost=6, range=4, casting_effects=["ice_2", "default"], gfx='ice_4', zoom=1.5, pause=0.8, td_gfx=[0.1, "shake", 0.75], sfx="content/sfx/sound/be/ice2.mp3", piercing=True,
                                       aim="bc", anchor=(0.5, 1.0), yo=40,
                                       desc="Freezes the air itself around the target, creating deadly ice blades.")
    SimpleMagicalAttack(u"Blizzarja", attributes=['magic', 'ice'], effect=10, multiplier=1.2, cost=4, range=4, casting_effects=["ice_1", "default"], gfx='ice_3', zoom=1.7, pause=1.25, td_gfx=[0.1, "shake", 1.1], sfx="content/sfx/sound/be/ice2.mp3", type="all_enemies", piercing=True,
                                       aim="bc", anchor=(0.5, 1.0), yo=60,
                                       desc="Quickly draws heat from a small area.")
    SimpleMagicalAttack(u"Zero Prism", attributes=['magic', 'ice'], effect=65, multiplier=1.5, cost=12, range=4, casting_effects=["ice_2", "default"], gfx='ice_5', zoom=2.1, pause=2.1, td_gfx=[0.3, "shake", 1.5], sfx="content/sfx/sound/be/ice4.mp3",
                                       aim="bc", anchor=(0.5, 1.0), yo=110,
                                       desc="Freezes the target into a solid ice block.")
    SimpleMagicalAttack(u"Ice Shards", attributes=['magic', 'ice'], effect=30, multiplier=1.5, cost=8, range=4, casting_effects=["ice_2", "default"], gfx='ice_6', zoom=2.0, pause=1.2, td_gfx=[0.1, "shake", 0.7], sfx="content/sfx/sound/be/ice2.mp3", piercing=True, type="all_enemies",
                                       aim="bc", anchor=(0.5, 1.0), yo=80,
                                       desc="Small part of the target immediately freezes and explodes.")
    SimpleMagicalAttack("Hailstorm", attributes=['magic', 'ice'], effect=100, multiplier=1.8, cost=20, range=4, casting_effects=["orb", "default"], gfx='ice_7', zoom=1.7, pause=2.0, td_gfx=[0.1, "shake", 1.9], sfx="content/sfx/sound/be/Hailstorm.mp3", piercing=True, true_pierce=True,
                                       aim="bc", anchor=(0.5, 1.0), yo=50,
                                       desc="Puts the target in a middle of a small, but violent snow storm.")
    # Earth:
    SimpleMagicalAttack(u"Stone", attributes=['magic', 'earth'], effect=20, multiplier=1.2, cost=5, range=4, casting_effects=["earth_1", "default"], gfx='earth_1', zoom=1.4, pause=2.0, td_gfx=[0.1, "shake", 1.7], sfx="content/sfx/sound/be/earth.mp3", type="all_enemies",
                                       aim="bc", anchor=(0.5, 1.0), yo=40,
                                       desc="Creates cloud of fragments of hardened clay.")
    SimpleMagicalAttack(u"Stonera", attributes=['magic', 'earth'], effect=30, multiplier=1.2, cost=7, range=4, casting_effects=["earth_1", "default"], gfx='earth_2', zoom=1.0, pause=1.5, td_gfx=[0.1, "shake", 0.8], sfx="content/sfx/sound/be/earth.mp3",
                                       aim="bc", anchor=(0.5, 1.0), yo=10,
                                       desc="Creates a spall, yet sharp spike.")
    SimpleMagicalAttack(u"Stonega", attributes=['magic', 'earth'], effect=25, multiplier=1.2, cost=6, range=4, casting_effects=["earth_1", "default"], gfx='earth_3', zoom=1.2, pause=1.5, td_gfx=[0.1, "shake", 1.2], sfx="content/sfx/sound/be/earth3.mp3", piercing=True,
                                       aim="bc", anchor=(0.5, 0.5), yo=0,
                                       desc="A small amount of magma moves to the surface, spilling on the target.")
    SimpleMagicalAttack(u"Stoneja", attributes=['magic', 'earth'], effect=10, multiplier=1.2, cost=7, range=4, casting_effects=["earth_2", "default"], gfx='earth_4', zoom=1.2, pause=1.2, td_gfx=[0.1, "shake", 0.9], sfx="content/sfx/sound/be/earth2.mp3", piercing=True, type="all_enemies",
                                       aim="bc", anchor=(0.5, 1.0), yo=40,
                                       desc="Small part of the target becomes stone and shatters into a thousand pieces.")
    SimpleMagicalAttack(u"Mudslide", attributes=['magic', 'earth'], effect=65, multiplier=1.5, cost=12, range=4, casting_effects=["earth_2", "default"], gfx='earth_5', zoom=1.5, pause=2.8, td_gfx=[0.1, "shake", 2.6], sfx="content/sfx/sound/be/earth4.mp3",
                                       aim="bc", anchor=(0.5, 1.0), yo=40,
                                       desc="Dirt, rocks and poisonous gases are pulled out of the ground under high pressure.")
    SimpleMagicalAttack(u"Transmutation", attributes=['magic', 'earth'], effect=50, multiplier=1.5, cost=10, range=4, casting_effects=["earth_2", "default"], gfx='earth_6', zoom=1.5, pause=2.0, td_gfx=[0.2, "shake", 1.8], sfx="content/sfx/sound/be/earth6.mp3", piercing=True,
                                       aim="bc", anchor=(0.5, 1.0), yo=50,
                                       desc="The land itself under the target becomes explosive and detonates.")
    SimpleMagicalAttack(u"Rift Line", attributes=['magic', 'earth'], effect=70, multiplier=1.8, cost=15, range=4, casting_effects=["earth_2", "default"], gfx='magma', zoom=2.0, pause=3.2, td_gfx=[0.5, "shake", 2.2], sfx="content/sfx/sound/be/rift_line.mp3", type="all_enemies", piercing=True, true_pierce=True,
                                       aim="bc", anchor=(0.5, 1.0), yo=50,
                                       desc="Brings a small flow of magma to the surface.")

    
    # Air:
    SimpleMagicalAttack(u"Aero", attributes=['magic', 'air'], effect=20, multiplier=1.2, cost=5, range=4, casting_effects=["air_1", "default"], gfx='air_1', zoom=1.2, pause=1.5, td_gfx=[0.1, "shake", 1.3], sfx="content/sfx/sound/be/air2.mp3", type="all_enemies",
                                       aim="center", anchor=(0.5, 0.5),
                                       desc="High pressure air cuts through armor and flesh like a hardened blade.")
    SimpleMagicalAttack(u"Aerora", attributes=['magic', 'air'], effect=30, multiplier=1.2, cost=7, range=4, casting_effects=["air_1", "default"], gfx='air_5', zoom=1.3, pause=0.9, td_gfx=[0.1, "shake", 0.8], sfx="content/sfx/sound/be/air1.mp3",
                                       desc="Causes damage by sand and branches picked up by the wind rather than air itself.")    
    SimpleMagicalAttack(u"Aeroga", attributes=['magic', 'air'], effect=25, multiplier=1.2, cost=6, range=4, casting_effects=["air_1", "default"], gfx='air_2', zoom=1.2, pause=1.5, td_gfx=[0.1, "shake", 1.3], sfx="content/sfx/sound/be/air3.mp3", piercing=True,
                                       aim="center", anchor=(0.5, 0.5),
                                       desc="Even for those who don't need to breathe instantaneous air pressure drop is dangerous.")
    SimpleMagicalAttack(u"Aeroja", attributes=['magic', 'air'], effect=10, multiplier=1.2, cost=4, range=4, casting_effects=["air_2", "default"], gfx='air_3', zoom=1.4, pause=1.5, td_gfx=[0.1, "shake", 1.2], sfx="content/sfx/sound/be/air2.mp3", piercing=True, type="all_enemies",
                                       aim="center", anchor=(0.5, 0.5),
                                       desc="High pressure air flows cover a small area.")
    SimpleMagicalAttack(u"Air Pressure", attributes=['magic', 'air'], effect=50, multiplier=1.5, cost=10, range=4, casting_effects=["air_2", "default"], gfx='air_4', zoom=1.2, pause=1.5, td_gfx=[0.1, "shake", 1.3], sfx="content/sfx/sound/be/air3.mp3", type="all_enemies", piercing=True,
                                       aim="center", anchor=(0.5, 0.5),
                                       desc="Pumps air from the target, crushing it by external atmospheric pressure.")
    SimpleMagicalAttack(u"Air Blast", attributes=['magic', 'air'], effect=100, multiplier=1.5, cost=20, range=4, casting_effects=["air_2", "default"], gfx='air_6', zoom=1.5, pause=1.5, td_gfx=[0.1, "shake", 1.0], sfx="content/sfx/sound/be/air3.mp3", piercing=True,
                                       aim="center", anchor=(0.5, 0.5),
                                       desc="Pumps air into the target, tearing it from the inside.")
    SimpleMagicalAttack("Vortex", attributes=['magic', 'air'], effect=85, multiplier=1.8, cost=18, range=4, casting_effects=["orb", "default"], gfx='vortex', zoom=2.2, pause=1.5, td_gfx=[0.1, "shake", 1.4], sfx="content/sfx/sound/be/vortex.mp3", type="all_enemies",
                                       aim="center", anchor=(0.5, 0.5),
                                       desc="Creates a small, but very powerful sphere of hurricane winds around the target.")

    # Electricity:
    SimpleMagicalAttack(u"Thunder", attributes=['magic', 'electricity'], effect=20, multiplier=1.2, cost=5, range=5, casting_effects=["electricity_1", "default"], gfx='electricity_1', zoom=1.5, pause=1.0, td_gfx=[0.2, "shake", 0.6], sfx="content/sfx/sound/be/thunder2.mp3", type="all_enemies",
                                       desc="Shocks targets with static electricity caused by friction of airborne particles.")
    SimpleMagicalAttack(u"Thundara", attributes=['magic', 'electricity'], effect=30, multiplier=1.2, cost=7, range=5, casting_effects=["electricity_1", "default"], gfx='electricity_2', zoom=1.7, pause=1.2, td_gfx=[0.1, "shake", 1.1], sfx="content/sfx/sound/be/thunder4.mp3",
                                       desc="Surrounds the target by brief electricity field.", aim="bc", anchor=(0.5, 1.0), yo=50)
    SimpleMagicalAttack(u"Thundaga", attributes=['magic', 'electricity'], effect=25, multiplier=1.2, cost=6, range=4, casting_effects=["electricity_2", "default"], gfx='electricity_4', zoom=1.8, pause=0.6, td_gfx=[0.05, "shake", 1.0], sfx="content/sfx/sound/be/thunder3.mp3", piercing=True,
                                       aim="center", anchor=(0.5, 0.5),
                                       desc="Creates plasma ball of ionized air near the target.")
    SimpleMagicalAttack(u"Thundaja", attributes=['magic', 'electricity'], effect=10, multiplier=1.2, cost=4, range=5, casting_effects=["electricity_1", "default"], gfx='electricity_3', zoom=2.2, pause=1.35, td_gfx=[0.2, "shake", 1.0], sfx="content/sfx/sound/be/thunder.mp3", type="all_enemies", piercing=True,
                                       desc="Covers a small area by lightning discharges.", aim="bc", anchor=(0.5, 1.0), yo=50)
    SimpleMagicalAttack(u"Thunderstorm", attributes=['magic', 'electricity'], effect=30, multiplier=1.5, cost=8, range=4, casting_effects=["electricity_2", "default"], gfx='electricity_5', zoom=1.6, pause=1.6, td_gfx=[0.15, "shake", 1.45], sfx="content/sfx/sound/be/thunder5.mp3", type="all_enemies", piercing=True,
                                       aim="tc", anchor=(0.5, 0.5),
                                       desc="Сovers a small area by numerous high-voltage discharges.")
    SimpleMagicalAttack(u"Electromagnetism", attributes=['magic', 'electricity'], effect=40, multiplier=1.5, cost=9, range=4, casting_effects=["electricity_2", "default"], gfx='electricity_6', zoom=1.8, pause=3.2, td_gfx=[0.3, "shake", 2.9], sfx="content/sfx/sound/be/thunder6.mp3", type="all_enemies",
    ...
    SimpleMagicalAttack(u"Holyra", attributes=['magic', 'light'], effect=30, multiplier=1.2, cost=7, range=4, casting_effects=["light_1", "default"], gfx='light_2', zoom=1.5, pause=1.25, td_gfx=[0.1, "shake", 1.1], sfx="content/sfx/sound/be/light3.mp3",
                                       aim="center", anchor=(0.5, 0.5),
                                       desc="A sphere of light burns the target from all sides.")
    SimpleMagicalAttack(u"Holyda", attributes=['magic', 'light'], effect=25, multiplier=1.2, cost=6, range=4, casting_effects=["light_1", "default"], gfx='light_3', zoom=2.5, pause=1.6, td_gfx=[0.1, "shake", 1.5], sfx="content/sfx/sound/be/light4.mp3", piercing=True,
                                       aim="center", anchor=(0.5, 0.5),
                                       desc="A smallest particle of stellar energy burns the target.")
    SimpleMagicalAttack(u"Holyja", attributes=['magic', 'light'], effect=10, multiplier=1.2, cost=4, range=4, casting_effects=["light_2", "default"], gfx='light_4', zoom=1.5, pause=2.04, td_gfx=[0.5, "shake", 1.4], sfx="content/sfx/sound/be/light5.mp3", piercing=True, type="all_enemies", 
                                       aim="bc", anchor=(0.5, 1.0), yo=70,
                                       desc="Gathers light around targets and then instantly releases it in the form of light beams.")
    SimpleMagicalAttack(u"Photon Blade", attributes=['magic', 'light'], effect=30, multiplier=1.5, cost=8, range=4, casting_effects=["light_2", "default"], gfx='light_5', zoom=1.9, pause=2.5, td_gfx=[0.5, "shake", 1.4], sfx="content/sfx/sound/be/dawn.mp3", type="all_enemies", piercing=True,
                                       desc="Infinitely thin blades of pure light slices targets.")
    SimpleMagicalAttack(u"Star Light", attributes=['magic', 'light'], effect=50, multiplier=1.5, cost=10, range=4, casting_effects=["light_2", "default"], gfx='light_6', zoom=1.4, pause=1.8, td_gfx=[0.1, "shake", 1.7], sfx="content/sfx/sound/be/light2.mp3", piercing=True,
                                       aim="center", anchor=(0.5, 0.5), desc="A powerful and painful flash of star light.")
    SimpleMagicalAttack("Forced Dawn", attributes=['magic', 'light'], effect=70, multiplier=1.8, cost=15, range=4, casting_effects=["circle_3", "default"], gfx='dawn', zoom=2.5, pause=3.5, td_gfx=[1.7, "shake", 1.2], sfx="content/sfx/sound/be/dawn.mp3", type="all_enemies", piercing=True,
                                       aim="bc", anchor=(0.5, 1.0), yo=40,
                                       desc="The energy of a whole sunrise quickly covers a small area.")
    
    # Darkness:
    SimpleMagicalAttack(u"Dark", attributes=['magic', 'darkness'], effect=20, multiplier=1.2, cost=5, range=4, casting_effects=["dark_1", "default"], gfx='darkness_1', zoom=1.3, pause=1.0, td_gfx=[0.1, "shake", 0.9], sfx="content/sfx/sound/be/darkness1.mp3", type="all_enemies",
                                       aim="center", anchor=(0.5, 0.5),
                                       desc="The mere presence of dark energy is dangerous for most creatures.")
    SimpleMagicalAttack(u"Darkra", attributes=['magic', 'darkness'], effect=30, multiplier=1.2, cost=7, range=4, casting_effects=["dark_1", "default"], gfx='darkness_2', zoom=1.4, pause=1.6, td_gfx=[0.1, "shake", 1.4], sfx="content/sfx/sound/be/darkness2.mp3",
                                       aim="center", anchor=(0.5, 0.5),
                                       desc="Darkness envelops the target, slowly killing it.")
    SimpleMagicalAttack(u"Darkga", attributes=['magic', 'darkness'], effect=25, multiplier=1.2, cost=6, range=4, casting_effects=["dark_1", "default"], gfx='darkness_3', zoom=1.4, pause=1.5, td_gfx=[0.9, "shake", 0.6], sfx="content/sfx/sound/be/darkness3.mp3", piercing=True,
                                       aim="center", anchor=(0.5, 0.5),
                                       desc="Negative energy concentrates in a very small area and then explodes.")
    SimpleMagicalAttack(u"Darkja", attributes=['magic', 'darkness'], effect=10, multiplier=1.2, cost=4, range=4, casting_effects=["dark_2", "default"], gfx='darkness_4', zoom=1.2, pause=1.5, td_gfx=[0.1, "shake", 1.2], sfx="content/sfx/sound/be/darkness2.mp3", piercing=True, type="all_enemies",
                                       aim="center", anchor=(0.5, 0.5),
                                       desc="Summons an abnormal and chaotic substances from a dark world that deforms targets.")
    SimpleMagicalAttack(u"Eternal Gluttony", attributes=['magic', 'darkness'], effect=50, multiplier=1.5, cost=10, range=4, casting_effects=["dark_2", "default"], gfx='darkness_5', pause=1.2, td_gfx=[0.1, "shake", 1.1], sfx="content/sfx/sound/be/horny2.mp3", piercing=True, 
                                       desc="Summons a dark creature to devour the target.")
    SimpleMagicalAttack(u"Black Hole", attributes=['magic', 'darkness'], effect=30, multiplier=1.5, cost=8, range=4, casting_effects=["dark_2", "default"], gfx='darkness_6', pause=1.5, td_gfx=[0.1, "shake", 1.2], sfx="content/sfx/sound/be/darkness3.mp3", type="all_enemies", piercing=True,
                                       desc="Creates a hole in spaace that leads to a dark dimension.")
    SimpleMagicalAttack("Other Light", attributes=['magic', 'darkness'], effect=70, multiplier=1.8, cost=15, range=4, casting_effects=["orb", "default"], gfx='darklight', zoom=1.3, pause=2.0, td_gfx=[0.2], sfx="content/sfx/sound/be/darklight.mp3", type="all_enemies", piercing=True, true_pierce=True,
