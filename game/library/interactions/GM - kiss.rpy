label interactions_kiss:
    ...
    if gm_last_success:
        ...
        if ct("Half-Sister") and dice(40):
            ...
            $rc("... *kiss*", "*kiss* *slurp* *slosh* <She's making patterns with her tongue>", "*kiss* ... *giggle* *kiss*", "momph*kiss*dufu*kiss*gae*kiss*mnn ... <Trying to talk, perhaps?>", "...Haah... It tastes like you... Hehe♪", "Huff, *smooch*, *slurp*... Hehe, I got my tounge inside...")    
        elif ct("Impersonal"):
