    ...
    if hero.take_money(25):
        if dice(70):           
            if chr.disposition > 600:
                ...
                $chr.disposition += (randint(5, 15))
            g "Thank you!"
            
        else:
            g "I don't want your money."
            $chr.disposition -= (randint(5, 12))
            $hero.add_money(25)
...
label interactions_gm100g:
    ...
    if hero.take_money(100):
        if dice(70):           
            if chr.disposition > 600:
                $chr.disposition += (randint(3, 6))
            else:
                $chr.disposition += (randint(15, 30))
            g "Thank you!"
            
        else:
            g "I don't want your money."
            $chr.disposition -= (randint(10, 25))
            $hero.add_money(100)
...
label interactions_gm500g:
    ...
    if hero.take_money(500):
        if dice(70):           
            if chr.disposition > 600:
                $chr.disposition += (randint(5, 10))
            else:
                $chr.disposition += (randint(25, 45))
            $rc("Thank you!", "Wow, how generous you are!")
            
        else:
            g "I don't want your money."
            $chr.disposition -= (randint(20, 35))
            $hero.add_money(500)
