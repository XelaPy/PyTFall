...
label int_girl_proposes_girlfriend: # character proposes to become lovers
    $ char.override_portrait("portrait", "shy")
    if ct("Impersonal"):
        $rc("I love you. I want to stay by your side.", "I love you. Let me hear your answer.", "I want you to date me. Will you accept me...?")
        ...
        $rc("I want to be your special person...", "I love you... Please let me be beside you, from now on.", "I have a proposal. Will you go out with me?")
    elif ct("Tsundere"):
        ...
        $rc("I love you! Your heart and soul, I want it all!", "I... I like you! Please be my lover!", "I love you... Please date me.")
    else:
