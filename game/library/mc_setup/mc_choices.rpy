label build_mc_stories:
    ...
    python:
        ...
        mc_stories["Mage"]["choices"] = OrderedDict(Arcane_Knight="content/gfx/interface/images/mc/arc.png",
                                                    Steam="content/gfx/interface/images/mc/fi.png")
                                                       
        mc_stories["Mage"]["Arcane_Knight"] = {}
        mc_stories["Mage"]["Arcane_Knight"]["class"] = "Mage"
        mc_stories["Mage"]["Arcane_Knight"]["text"] = "He chose to learn the secrets of light and darkness."
        ...
        mc_stories["Mage"]["MC"]["Arcane_Knight"]["choices"] = OrderedDict(l="Angel",
        ...
        mc_stories["Mage"]["MC"]["Arcane_Knight"]["Angel"] = {} 
        mc_stories["Mage"]["MC"]["Arcane_Knight"]["Angel"]["header"] = "Angel"
        mc_stories["Mage"]["MC"]["Arcane_Knight"]["Angel"]["text"] = "Most high angels don't care about mortals and their carnal pleasures. Your mother was the same until she was summoned by your father's magic to share the secrets of Light. In exchange he taught her the ways of mortals."
        mc_stories["Mage"]["MC"]["Arcane_Knight"]["Angel"]["label"] = "mc_setup_mage_shadow_angel"
        
        mc_stories["Mage"]["MC"]["Arcane_Knight"]["Angel"]["Intangible"] = {}
        mc_stories["Mage"]["MC"]["Arcane_Knight"]["Angel"]["Intangible"]["text"] = "You are not entirely suitable for the world of mortals, just like your mother. All attacks and magic are less effective against you, but all your attacks and magic are less effective too."
        mc_stories["Mage"]["MC"]["Arcane_Knight"]["Angel"]["Intangible"]["label"] = "mc_setup_mage_shadow_angel_intangible"
        
        mc_stories["Mage"]["MC"]["Arcane_Knight"]["Angel"]["Illusive"] = {}
        mc_stories["Mage"]["MC"]["Arcane_Knight"]["Angel"]["Illusive"]["text"] = "Due to your heritage, you exist between the realm of light and mortal reality. Physical damage is not a big problem for you, but it leads to unusual results during intimacy."
        mc_stories["Mage"]["MC"]["Arcane_Knight"]["Angel"]["Illusive"]["label"] = "mc_setup_mage_shadow_angel_illusive"
        
        mc_stories["Mage"]["MC"]["Arcane_Knight"]["Angel"]["Creature of Light"] = {}
        mc_stories["Mage"]["MC"]["Arcane_Knight"]["Angel"]["Creature of Light"]["text"] = "Light spells now heal you instead of hurting, but your Water and Ice spells are a bit less effective."
        mc_stories["Mage"]["MC"]["Arcane_Knight"]["Angel"]["Creature of Light"]["label"] = "mc_setup_mage_shadow_angel_light"
        
        mc_stories["Mage"]["MC"]["Arcane_Knight"]["Vampire"] = {} 
        mc_stories["Mage"]["MC"]["Arcane_Knight"]["Vampire"]["header"] = "Vampire"
        mc_stories["Mage"]["MC"]["Arcane_Knight"]["Vampire"]["text"] = "For decades he studied vampires and their unnatural longevity. Eventually he captured the local vampire queen, but her seductiveness quickly turned his magical experiments into sexual ones."
        mc_stories["Mage"]["MC"]["Arcane_Knight"]["Vampire"]["label"] = "mc_setup_mage_shadow_vampire"
        mc_stories["Mage"]["MC"]["Arcane_Knight"]["Vampire"]["class"] = "Assassin"
        
        mc_stories["Mage"]["MC"]["Arcane_Knight"]["Vampire"]["Creature of Night"] = {}
        mc_stories["Mage"]["MC"]["Arcane_Knight"]["Vampire"]["Creature of Night"]["text"] = "Darkness spells now heal you instead of hurting, but your Fire and Electricity spells are a bit less effective."
        mc_stories["Mage"]["MC"]["Arcane_Knight"]["Vampire"]["Creature of Night"]["label"] = "mc_setup_mage_shadow_vampire_night"
        
        mc_stories["Mage"]["MC"]["Arcane_Knight"]["Vampire"]["Blood Master"] = {}
        mc_stories["Mage"]["MC"]["Arcane_Knight"]["Vampire"]["Blood Master"]["text"] = "Only pure vampires have access to blood magic, but your heritage still gives a few perks when blood is involved. Girls whose virginity was taken by you are more obedient."
        mc_stories["Mage"]["MC"]["Arcane_Knight"]["Vampire"]["Blood Master"]["label"] = "mc_setup_mage_shadow_vampire_blood"
        
        mc_stories["Mage"]["MC"]["Arcane_Knight"]["Vampire"]["Perfect Reflexes"] = {}
        mc_stories["Mage"]["MC"]["Arcane_Knight"]["Vampire"]["Perfect Reflexes"]["text"] = "You inherited your mother's reflexes, which helps to evade attacks. Sadly, mortal body is not suitable for vampire speed, which affected you health."
        mc_stories["Mage"]["MC"]["Arcane_Knight"]["Vampire"]["Perfect Reflexes"]["label"] = "mc_setup_mage_shadow_vampire_reflex"
