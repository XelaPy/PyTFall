...
label girl_training:
    ...
    hide screen pyt_girl_training
    jump girl_profile
    

screen pyt_girl_training:
    ...
    if training_screen_current is None:
        ...
        use pyt_girl_training_schooling
    
    else:
        use pyt_girl_training_trainer
...
# Personal sub-screen
screen pyt_girl_training_trainer:
                    ...
                    hbox:
                        ...
                        for course in training_screen_course.get_options(char, training_screen_trainer, one_off_only=False):
                            frame:
                                background Frame("content/gfx/frame/p_frame2.png", 10, 10)
                                xysize (210, 145)
                                use pyt_girl_training_lesson(course, tt, False)
                
                vbar value YScrollValue("lesson_vp")
    

screen pyt_girl_training_lesson(course, tt, show_image):
    vbox:
        style_group "content"
        xalign 0.5
        null height 2
        ...
        if show_image:
            ...
            frame:
                ...
                imagebutton:
                    ...
                    hovered tt.action(u"%s\nGirls being trained: %s"%(course.desc, ", ".join([girl.fullname for girl in hero.girls if girl_is_training(girl) is course])))
...
# Schools sub-screen
screen pyt_girl_training_schooling:
    # Course viewport
    frame:
        background Frame("content/gfx/frame/arena_d.png", 10, 10)
        area (620, 71, 660, 622)
                ...
                hbox:
                    ...
                    for course in training_screen_current.courses:
                        frame:
                            ...
                            xpadding 5
                            ypadding 5
                            use pyt_girl_training_lesson(course, tt, True)
            vbar value YScrollValue("course_vp")
