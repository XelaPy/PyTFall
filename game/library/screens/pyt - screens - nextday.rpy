label next_day:
    ...
    while nd_buildings:
        ...
        python:
            ...
            # TODO: NEEDS TO BE REWRITTEN to be generated by calling each upgrade to account for multi-clients upgrades (Bar, Club, etc.)!
            nd_clients = list(building.create_customer() for client in xrange(building.get_clients())) # Full clients list!
            stop_whore_job = False
            tl.timer("Generating clients")
