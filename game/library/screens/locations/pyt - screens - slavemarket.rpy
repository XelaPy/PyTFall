...
screen pyt_slave_shopping(store, tt_text, buy_button, buy_tt):
            ...
            hbox:
                ...
                frame:
                    ...
                    if store == jail and store.girl.flag("sentence_type") == "SE_capture":
                        textbutton "Retrieve":
                            xsize 150
                            action Show("pyt_se_captured_retrieval")
    ...
    use pyt_top_stripe(True)
screen pyt_se_captured_retrieval(pos=(900, 300)):
    zorder 3
    modal True
