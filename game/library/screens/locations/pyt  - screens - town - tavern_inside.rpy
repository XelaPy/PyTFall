label tavern_inside:
    ...
    python:
        ...
        if pytfall.world_actions.location("tavern_inside"):
            pytfall.world_actions.add("brawl_join", "Join in!", Show("pyt_wip_screen"),
                                      condition=Iff(global_flag_complex("tavern_entry_brawl"), "==", S(renpy_store_complex("day"), "+", (hero, "AP"))))
            
            pytfall.world_actions.add("brawl_stay", "Stay", Show("pyt_wip_screen"),
                                      condition=Iff(global_flag_complex("tavern_entry_brawl"), "!=", S(renpy_store_complex("day"), "+", (hero, "AP"))))
            pytfall.world_actions.finish()
    
    show screen pyt_tavern_inside
    ...
    hide screen pyt_tavern_inside
    jump pyt_city

#to be deleted later    
screen pyt_wip_screen(size=(500, 300), use_return=False):
    modal True
    zorder 10
    ...
    fixed:
        ...
        vbox:
            ...
            textbutton "Ok" action If(use_return, true=Return(), false=Hide("pyt_wip_screen")) minimum(150, 30) xalign 0.3

    
screen pyt_tavern_inside:
