            ...
            frame:
                ...
                vbox:
                    ...
                    textbutton "Show Daily Report":
                        xalign 0.5
                        action [ShowTransient("pyt_arena_report")]
                    textbutton "Reputation Ladder":
                        xalign 0.5
                        action [ShowTransient("pyt_arena_rep_ladder")]
                ...
                vbox:
                    ...
                    hbox:
                        ...
                        textbutton "{size=24}{color=[black]}Bestiary":
                            action [Hide("pyt_arena_inside"), Show("pyt_arena_bestiary")]
                ...
                vbox:
                    ...
                    hbox:
                        ...
                        textbutton "{size=24}{color=[black]}1v1":
                            action Show("pyt_arena_lineups", transition=dissolve, container=pytfall.arena.lineup_1v1)
                        textbutton "{size=24}{color=[black]}2v2":
                            action Show("pyt_arena_lineups", transition=dissolve, container=pytfall.arena.lineup_2v2)
                        textbutton "{size=24}{color=[black]}3v3":
                            action Show("pyt_arena_lineups", transition=dissolve, container=pytfall.arena.lineup_3v3)
            ...
            frame:
                ...
                vbox:
                    ...
                    hbox:
                        ...
                        style_group "basic"
                        textbutton "{size=24}{color=[black]}1v1":
                            action Show("pyt_arena_matches", container=pytfall.arena.matches_1v1, transition=dissolve, vs_img=ProportionalScale("content/gfx/interface/images/vs_3.png", 130, 130))
                        textbutton "{size=24}{color=[black]}2v2":
                            action Show("pyt_arena_matches", container=pytfall.arena.matches_2v2, transition=dissolve, vs_img=ProportionalScale("content/gfx/interface/images/vs_2.png", 130, 130))
                        textbutton "{size=24}{color=[black]}3v3":
                            action Show("pyt_arena_matches", container=pytfall.arena.matches_3v3, transition=dissolve, vs_img=ProportionalScale("content/gfx/interface/images/vs_4.png", 130, 130))
            ...
            frame:
                ...
                vbox:
                    ...
                    hbox:
                        ...
                        spacing 5
                        textbutton "{size=24}{color=[black]}1v1":
                            action Show("pyt_arena_dogfights", transition=dissolve, container=pytfall.arena.dogfights_1v1)
                        textbutton "{size=24}{color=[black]}2v2":
                            action Show("pyt_arena_dogfights", transition=dissolve, container=pytfall.arena.dogfights_2v2)
                        textbutton "{size=24}{color=[black]}3v3":
                            action Show("pyt_arena_dogfights", transition=dissolve, container=pytfall.arena.dogfights_3v3)
    use pyt_top_stripe(True)
             
screen pyt_arena_matches(container=None, vs_img=None):
    ...
    frame:
        ...
        button:
            style_group "basic"
            action Hide("pyt_arena_matches")
            minimum(50, 30)
            align (0.5, 0.9995)
            text  "OK"
            
        
screen pyt_arena_lineups(container):
    modal True
    zorder 1
    ...
    frame:
        ...
        button:
            style_group "basic"
            action Hide("pyt_arena_lineups")
            minimum(50, 30)
            align (0.5, 0.9995)
            text  "OK"
            
        
screen pyt_arena_rep_ladder():
    modal True
    zorder 1
...
screen pyt_arena_dogfights(container={}):
    modal True
    zorder 1
    ...
    frame:
        ...
        button:
            style_group "basic"
            action Hide("pyt_arena_dogfights")
            minimum(50, 30)
            align (0.5, 0.9995)
            text  "OK"
        
screen pyt_arena_bestiary():
...
screen pyt_arena_af_popup(w_team, l_team, condition):
        ...
        hbox:
            ...
            if len(w_team) == 1:
                frame:
                    ...
                    maximum(426, 376)
                    xfill True
                    add(ProportionalScale("content/gfx/interface/images/swords-shield.png", 426, 376)) align(0.5, 0.5)
                frame:
                    background Null()
                    minimum(426, 376)
                    maximum(426, 376)
            ...
            if len(w_team) == 2:
                ...
                frame:
                    ...
                    maximum(426, 376)
                    xfill True
                    if w_team[1].has_image("fighting"):
                        add(w_team[1].show("fighting", resize=(426, 376), cache=True)) align(0.5, 0.5)
                    else:
                        add(w_team[1].show("battle", resize=(426, 376), cache=True)) align(0.5, 0.5)
                    use pyt_arena_stats(w_team[1])
            ...
            if len(w_team) == 3:
                ...
                frame:
                    ...
                    maximum(426, 376)
                    xfill True
                    if w_team[2].has_image("fighting"):
                        add(w_team[2].show("fighting", resize=(426, 376), cache=True)) align(0.5, 0.5)
                    else:
                        add(w_team[2].show("battle", resize=(426, 376), cache=True)) align(0.5, 0.5)
                    use pyt_arena_stats(w_team[2])
                    
        
    frame:
        at move_bpwe(start_pos=(0, -400), end_pos=(0, 0), t=0.7)
        xysize(config.screen_width, config.screen_height/2)
        background Solid((100, 100, 250, 150))
        hbox:
            align(0.5, 0.5)
    ...
    $ img=im.Scale("content/gfx/interface/buttons/close.png", 60, 60)       
    imagebutton:
        align (1.0, 0.0)
        idle (img)
    ...
    fixed:
        ...
        if condition == "Victory":
            text("{color=[red]}{size=+80}{font=fonts/Rubius.ttf}VICTORY!!!")
        else:
            text("{color=[red]}{size=+80}{font=fonts/Rubius.ttf}Defeat...")
...
screen pyt_confirm_match():
    ...
    frame:
        ...
        hbox:
            ...
            spacing 40
            textbutton "No":
                action Hide("pyt_confirm_match")
            textbutton "Yes":
                action Return(["challenge", "confirm_match"])
            
screen pyt_arena_report():
    ...
    frame:
        ...
        button:
            style_group "basic"
            action Hide("pyt_arena_report")
            minimum(50, 30)
            align (0.5, 0.9)
            text  "OK"
                
screen pyt_arena_stats(member):
...
init: # ChainFights vs Mobs:
    ...
    screen pyt_confirm_chainfight(range, interval, length_multiplier, d):
        zorder 2
        modal True
        ...
        hbox at slide(so1=(0, 700), t1=0.7, so2=(0, 700), t2=0.7):
            ...
            textbutton "{b}{color=[blue]}Give Up :( ":
                action [Hide("pyt_arena_inside"), Hide("pyt_chain_fight"), Hide("pyt_confirm_chainfight"), SetField(pytfall.arena, "cf_count", 0),
            ...
            textbutton "{b}{color=[red]}Fight!!!":
                action [Hide("pyt_arena_inside"), Hide("pyt_chain_fight"), Hide("pyt_confirm_chainfight"), SetField(pytfall.arena, "cf_bonus", False), Return(["challenge", "chainfight"])]
    
    screen pyt_arena_finished_chainfight(w_team):
        zorder  3
        modal True
