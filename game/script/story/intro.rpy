...
label intro:
    ...
    "One of them is PyTFall, a relatively small town in neutral lands on the border of the Median Empire."

    show bg jail with dissolve
    "It was a time when slaves had fewer rights than pets..."
    extend " They were severely punished and could be executed on the spot by their masters without repercussions for the slightest infraction."
    ...
    "First few incidents were violently suppressed by the Masters..."
