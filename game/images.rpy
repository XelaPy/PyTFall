...
init:
    ...
    image skills_book_plus = ProportionalScale("content/gfx/be/buffs/skills_book_plus.png", 20, 20)
    image skills_book_minus = ProportionalScale("content/gfx/be/buffs/skills_book_minus.png", 20, 20)
    image skills_knowledge_plus = ProportionalScale("content/gfx/be/buffs/skills_knowledge_plus.png", 20, 20)
    image skills_knowledge_minus = ProportionalScale("content/gfx/be/buffs/skills_knowledge_minus.png", 20, 20)
    image skills_perf_plus = ProportionalScale("content/gfx/be/buffs/skills_perf_plus.png", 20, 20)
    image skills_perf_minus = ProportionalScale("content/gfx/be/buffs/skills_perf_minus.png", 20, 20)
