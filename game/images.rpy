...
init:
    ...
    image ice_element_be_viewport = ProportionalScale("content/gfx/interface/images/small_ice.png", 15, 15)
    image air_element_be_viewport = ProportionalScale("content/gfx/interface/images/small_air.png", 15, 15)
    image ele_element_be_viewport = ProportionalScale("content/gfx/interface/images/small_ele.png", 15, 15)
    image light_element_be_viewport = ProportionalScale("content/gfx/interface/images/small_light.png", 15, 15)
    image healing_be_viewport = ProportionalScale("content/gfx/interface/images/healing.png", 13, 13)
    image poison_be_viewport = ProportionalScale("content/gfx/interface/images/poison.png", 15, 15)
    image physical_be_viewport = ProportionalScale("content/gfx/interface/images/physical.png", 15, 15)
    ...
    image ice_element_be_size20 = ProportionalScale("content/gfx/interface/images/small_ice.png", 20, 20)
    image air_element_be_size20 = ProportionalScale("content/gfx/interface/images/small_air.png", 20, 20)
    image ele_element_be_size20 = ProportionalScale("content/gfx/interface/images/small_ele.png", 20, 20)
    image light_element_be_size20 = ProportionalScale("content/gfx/interface/images/small_light.png", 20, 20)
    image healing_be_size20 = ProportionalScale("content/gfx/interface/images/healing.png", 18, 18)
    image poison_be_size20 = ProportionalScale("content/gfx/interface/images/poison.png", 20, 20)
    image physical_be_size20 = ProportionalScale("content/gfx/interface/images/physical.png", 20, 20)