...
python: # Sword attacks:
    ...
    MultiAttack("Sword Slash 2X", attributes=["melee", "physical"], critpower=.02, multiplier=.65,
            ...
            main_effect={"gfx": ProportionalScale("content/gfx/be/swords.webp", 150, 150),
...
python: # Daggers Attacks:
    ...
    MultiAttack("Dagger Strike 4X", attributes=["melee", "physical"], critpower=.075,
            ...
            main_effect={"gfx": ProportionalScale("content/gfx/be/daggers.webp", 150, 150),
...
python: # Claw Attacks:
    ...
    MultiAttack("Claw Slash 2X", attributes=["melee", "physical"], critpower=.1,
            ...
            main_effect={"gfx": ProportionalScale("content/gfx/be/claws.webp", 150, 150),
                         "sfx": "content/sfx/sound/be/claw_attack.mp3",
...
python: # Axes Attack:
    ...
    MultiAttack("Axe Strike 2X", attributes=["melee", "physical"], critpower=.15,
                ...
                main_effect={"gfx": ProportionalScale("content/gfx/be/axes.webp", 150, 150),
...
python: # Scythe Attacks:
    ...
    MultiAttack("Scythe Slash 2X", attributes=["melee", "physical"], critpower=.5,
            ...
            main_effect={"gfx": ProportionalScale("content/gfx/be/scythe.webp", 150, 150),
                         "sfx": "content/sfx/sound/be/scythe_attack.mp3",
                         "duration": .6, "times": 2},
            target_sprite_damage_effect={"gfx": "shake", "initial_pause": .05, "duration": .55},
            target_death_effect={"gfx": "dissolve", "initial_pause": .5, "duration": .5})
...
python: # Whip Attacks:
    ...
    MultiAttack("Whip Strike 2X", attributes=["melee", "physical"], critpower=.1,
            ...
            main_effect={"gfx": ProportionalScale("content/gfx/be/whip.webp", 150, 150),
...
python: # Buffs:
    DefenceBuffSpell("Aery Field", menu_pos=6, attributes=["status", "air"], kind="buff",
            ...
            main_effect={"gfx": Transform(AlphaBlend("ranged_shield1_webm",
                         "ranged_shield1_webm", green_shield(350, 300), alpha=True),
                         size=(350, 300)), "sfx": "content/sfx/sound/be/m_shield.ogg",
                         "duration": .967, "aim": {"point": "center", "anchor": (.5, .5), "yo": 0}},
            target_sprite_damage_effect={"gfx": None},
    ...
    DefenceBuffSpell("Aery Shield", menu_pos=7, attributes=["status", "air"],
                     ...
                     main_effect={"gfx": Transform(AlphaBlend("ranged_shield1_webm",
                                  "ranged_shield1_webm", green_shield(350, 300), alpha=True),
                                  size=(350, 300)), "sfx": "content/sfx/sound/be/m_shield.ogg", "duration": .967,
                                  "aim": {"point": "center", "anchor": (.5, .5), "yo": 0}},
                     target_sprite_damage_effect={"gfx": None},
                     target_damage_effect={"gfx": None},
                     target_death_effect={"gfx": None})
