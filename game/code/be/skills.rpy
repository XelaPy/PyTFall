...
python: # We allow this shitty indent just this one time :D
    ...
    BE_Action(u"Light Slash", range=1, attributes=["melee", "physical", "light"], critpower=.3, effect=100, multiplier=1.15, vitality_cost=8, menu_pos=1.5,
            ...
            main_effect={"gfx": Transform("angel_sword_webm", zoom=1.1), "sfx": "content/sfx/sound/be/light3.mp3", "duration": .35, "aim": {"point": "center", "anchor": (.5, .5)}, "hflip": True},
            target_sprite_damage_effect={"gfx": "shake", "initial_pause": .1, "duration": .25},
            target_death_effect={"gfx": "dissolve", "initial_pause": .2, "duration": .5})
    ArealSkill(u"Light Field", range=3, attributes=["ranged", "light", "inevitable"], critpower=.2,
            ...
            main_effect={"gfx": Transform("holy_sword_webm", zoom=1.2), "sfx": "content/sfx/sound/be/light_field.mp3", "duration": 2.7, "aim": {"anchor": (.6, .8), "xo": 0, "yo":0}, "hflip": True},
    ...
    BE_Action(u"Angelic Rain", menu_pos=2, range=2, attributes=["ranged", "physical", "light"], critpower=.5,
            ...
            main_effect={"gfx": Transform("angel_swords_webm", zoom=1.3), "sfx": "content/sfx/sound/be/light_rain.ogg", "duration": .97, "aim": {"point": "tc", "anchor": (.5, .5)}, "hflip": True},
    ...
    BE_Action(u"Big Ice Break", range=2, attributes=["ranged", "ice"], menu_pos=1.4,
            ...
            main_effect={"gfx": Transform("ice_dagger_webm", zoom=1.4), "sfx": "content/sfx/sound/be/knife_ice.mp3",
    ...
    BE_Action(u"Excalibur Slash", range=1, attributes=["melee", "light", "darkness", "physical"],
            ...
            main_effect={"gfx": Transform("omni_sword_webm", zoom=1.1), "sfx": "content/sfx/sound/be/excal.ogg",
                         "duration": .27, "aim": {"point": "center", "anchor": (.5, .5)}, "hflip": True},
            target_sprite_damage_effect={"gfx": "shake", "initial_pause": .1, "duration": .25},
    ...
    BE_Action(u"Full Power Slash", menu_pos=3, range=2, attributes=["melee", "physical", "light", "darkness", "earth", "fire", "air"],
            ...
            main_effect={"gfx": Transform("planet_slash_webm", zoom=1.1), "sfx": "content/sfx/sound/be/exc_bl.ogg", "duration": 1.2,
                         "aim": {"point": "tc", "anchor": (.5, .5), "xo": 80}, "hflip": True},
    ...
    ArealSkill(u"Consecutive Slashes", range=3, attributes=["melee", "physical", "light", "darkness", "ice", "electricity", "inevitable"],
            ...
            main_effect={"gfx": Transform("universe_slash_webm", zoom=.9), "sfx": "content/sfx/sound/be/exc_full.ogg", "duration": 1.7,
                         "aim": {"anchor": (.5, .5), "xo": 100, "yo":-100}, "hflip": True, "webm_size": (1000, 800)},
    ...
    BE_Action(u"Soul Blade", menu_pos=1.4, range=1, attributes=["melee", "physical"], effect=30,
            ...
            main_effect={"gfx": Transform("soul_sword_webm", zoom=1.1), "sfx": "content/sfx/sound/be/soul_sword.mp3", "duration": .5,
                         "aim": {"point": "center", "anchor": (.5, .5), "xo": 80}, "hflip": True},
    ...
    BE_Action(u"Solar Incision", menu_pos=1.3, range=2, attributes=["melee", "fire", "physical"],
            ...
            main_effect={"gfx": Transform("fire_sword_webm"), "sfx": "content/sfx/sound/be/fire_sword.mp3", "duration": 1.1,
    ...
    MultiAttack("Bow Shot 2X", attributes=["ranged", "physical"], critpower=.02, multiplier=.65, effect=20, range=3, vitality_cost=2, menu_pos=.1,
            ...
            target_sprite_damage_effect={"gfx": "shake", "initial_pause": .05, "duration": .55},
            target_death_effect={"gfx": "dissolve", "initial_pause": .6, "duration": .5})
    MultiAttack("Bow Shot 4X", attributes=["ranged", "physical"], critpower=.04, multiplier=.8, effect=50, range=4, vitality_cost=5, menu_pos=.2,
            ...
            target_death_effect={"gfx": "dissolve", "initial_pause": 1.0, "duration": .5})
    BE_Action(u"Light Shot", range=4, attributes=["ranged", "physical", "light"], critpower=.2, multiplier=.9, effect=60, vitality_cost=5, menu_pos=1.0,
            desc="Shot an arrow made of light.", item_only=True,
            main_effect={"gfx": Transform("angel_bow_attack_webm", zoom=1.1), "sfx": "content/sfx/sound/be/light3.mp3", "duration": .96, "aim": {"point": "center", "anchor": (.5, .5)}},
    ...
    BE_Action(u"Dark Shot", range=4, attributes=["ranged", "physical", "darkness"], critpower=.4, multiplier=.95, effect=70, vitality_cost=4, health_cost=2, menu_pos=1.0,
            desc="Shot an arrow made of darkness.", item_only=True,
            main_effect={"gfx": Transform("demon_bow_attack_webm", zoom=1.1), "sfx": "content/sfx/sound/be/demon_sword.ogg", "duration": .96, "aim": {"point": "center", "anchor": (.5, .5)}},
            target_sprite_damage_effect={"gfx": "on_darkness", "initial_pause": .1, "duration": .25},
            target_death_effect={"gfx": "dissolve", "initial_pause": .2, "duration": .4})
    BE_Action("Poison Arrow", attributes=["ranged", "physical", "poison"], critpower=0, multiplier=.8, effect=15, range=4, vitality_cost=4, menu_pos=1.5, piercing=True,
            desc="Shot a poisonous arrow.", item_only=True,
            main_effect={"gfx": Transform("green_hit_webm", zoom=1.1), "sfx": "content/sfx/sound/be/elf_arrow.ogg", "duration": .56, "hflip": True},
            target_sprite_damage_effect={"gfx": "poisoned_with_shake", "initial_pause": .1, "duration": .4})
    ArrowsSkill(u"Emerald Arrow", menu_pos=1.6, attributes=["ranged", "air", "earth"], critpower=.3, effect=55, multiplier=.95, vitality_cost=12, mp_cost=3, range=4, piercing=True,
            desc="Shot an arrow empowered with nature itself.", item_only=True,
            firing_effects={"gfx": "emerald_bow_webm", "sfx": "content/sfx/sound/be/elf_bow.ogg", "duration": .86},
            ...
            main_effect={"gfx": "emerald_bow_hit_webm", "sfx": "content/sfx/sound/be/elf_arrow.ogg", "duration": .46, "aim": {"anchor": (.5, .5)}},
    ...
    ArrowsSkill(u"Trinity Arrow", menu_pos=2, attributes=["ranged", "light"], effect=95, critpower=.3, multiplier=1.3, vitality_cost=30, mp_cost=5, range=4, piercing=True,
            ...
            target_damage_effect={"gfx": "battle_bounce", "initial_pause": .021},
            main_effect={"gfx": Transform("angel_bow_hit_webm", zoom=1.5), "sfx": "content/sfx/sound/be/light3.mp3", "duration": .36, "aim": {"anchor": (.5, .5)}},
    ...
    P2P_Skill(u"Midnight Arrow", menu_pos=2, range=3, attributes=["ranged", "physical", "darkness"], effect=100, multiplier=1.3, vitality_cost=20, health_cost=10, critpower=.3,
            ...
            projectile_effects={"gfx": "demon_bow_arrow_webm", "sfx": "content/sfx/sound/be/elf_bow.ogg", "duration": .56, "aim": {"point": "center", "anchor": (.5, .5)}},
            main_effect={"gfx": "demon_bow_hit_webm", "sfx":"content/sfx/sound/be/demon_core.ogg", "duration": .36, "aim": {"anchor": (.5, .5), "xo": 0 ,"yo": 0}, "hflip": True},
            target_sprite_damage_effect={"gfx": "on_dark_with_shake", "initial_pause": .01, "duration": .2},
            target_death_effect={"gfx": "dissolve", "initial_pause": .2, "duration": .15},
            dodge_effect={"initial_pause": .005})
    BE_Action("Fire Shot", attributes=["ranged", "physical", "fire"], critpower=.1, multiplier=.85, effect=30, range=3, vitality_cost=3, menu_pos=1.0,
            desc="Shot a fire arrow.", item_only=True,
            main_effect={"gfx": Transform("simple_fire_bow_attack_webm", zoom=.8), "sfx": "content/sfx/sound/be/bow_attack.mp3", "duration": .67, "hflip": True},
    ...
    BE_Action("Ice Shot", attributes=["ranged", "physical", "ice"], critpower=.1, multiplier=.85, effect=30, range=3, vitality_cost=3, menu_pos=1.0,
            desc="Shot an ice arrow.", item_only=True,
            main_effect={"gfx": Transform("simple_ice_bow_attack_webm", zoom=.8), "sfx": "content/sfx/sound/be/bow_attack.mp3", "duration": .57, "hflip": True},
    ...
    ArrowsSkill(u"Fire Arrow", menu_pos=1.2, attributes=["ranged", "fire", "air"], effect=45, multiplier=1.0, critpower=.2, mp_cost=5, vitality_cost=10, range=4, piercing=True,
            ...
            target_damage_effect={"gfx": "battle_bounce", "initial_pause": .021},
            main_effect={"gfx": "Fire Arrow impact", "sfx": None, "duration": .51, "aim": {"anchor": (.5, .5)}},
    ...
    ArrowsSkill("Ice Arrow", menu_pos=1.2, attributes=["ranged", "ice", "water"], effect=45, multiplier=1.0, critpower=.2, mp_cost=5, vitality_cost=10, range=4, piercing=True,
            ...
            main_effect={"gfx": "Ice Arrow impact", "sfx": None, "duration": .51, "aim": {"anchor": (.5, .5), "xo": 0 ,"yo": 0}},
            attacker_effects={"gfx": "ice_2", "sfx": "default"},
            target_damage_effect={"gfx": "battle_bounce", "initial_pause": .021},
            target_sprite_damage_effect={"gfx": "frozen_with_shake", "initial_pause": .01, "duration": .3},
            target_death_effect={"gfx": "dissolve", "initial_pause": .3, "duration": .5},
            dodge_effect={"initial_pause": .1})
    BE_Action(u"Arc Strike", menu_pos=1.0, range=3, attributes=["ranged", "physical"], effect=35, multiplier=.9, critpower=.15, vitality_cost=10, mp_cost=5, type="all_enemies",
            desc="Countless enchanted arrows are coming from above.", item_only=True,
            main_effect={"gfx": Transform("magic_bow_webm", zoom=1.1), "sfx": "content/sfx/sound/be/enc_arrows.ogg", "duration": .67, "aim": {"point": "center", "anchor": (.5, .5)}},
    ...
    BE_Action("Crossbow Shot", attributes=["ranged", "physical"], critpower=.1, multiplier=.55, effect=10, range=4, vitality_cost=1, menu_pos=0,
            ...
            main_effect={"gfx": "simple_crossbow_attack_webm", "sfx": "content/sfx/sound/be/crossbow_attack.mp3", "duration": .37, "hflip": True},
...
##### Magic:
    ...
    BE_Action(u"Fire", menu_pos=0, attributes=["magic", "fire"], effect=10, multiplier=1.0, type="all_enemies", mp_cost=10, range=4,
            ...
            main_effect={"gfx": Transform("fire_1", zoom=1.7), "sfx": "content/sfx/sound/be/fire4.mp3", "duration": 2.0, "aim": {"point": "bc", "anchor": (.5, 1.0), "yo": 75}},
    ...
    BE_Action(u"Fira", menu_pos=.1, attributes=["magic", "fire"], effect=10, multiplier=1.1, mp_cost=8, range=4,
            ...
            attacker_effects = {"gfx": "fire_1", "sfx": "default"},
            main_effect={"gfx": Transform("fire_2", zoom=1.5), "sfx": "content/sfx/sound/be/fire4.mp3", "duration": 2.0, "aim": {"point": "bc", "anchor": (.5, 1.0), "yo": 40}},
    ...
    BE_Action(u"Firaga", menu_pos=.2, attributes=["magic", "fire"], effect=10, multiplier=.9, mp_cost=12, range=4, piercing=True,
            ...
            main_effect={"gfx": Transform("fire_4", zoom=1.5), "sfx": "content/sfx/sound/be/fire6.mp3", "duration": 5.0, "aim": {"point": "bc", "anchor": (.5, 1.0), "yo": 40}},
    ...
    BE_Action(u"Firaja", menu_pos=.3, attributes=["magic", "fire"], effect=6, multiplier=.8, mp_cost=15, range=4, type="all_enemies", piercing=True,
            ...
            attacker_effects={"gfx": "fire_1", "sfx": "default"},
            main_effect={"gfx": Transform("fire_3", zoom=1.5), "sfx": "content/sfx/sound/be/fire5.mp3", "duration": 3.5, "aim": {"point": "bc", "anchor": (.5, 1.0), "yo": 40}},
    ...
    P2P_Skill(u"Fireball", menu_pos=.5, attributes=["magic", "fire"], effect=50, multiplier=1.3, mp_cost=30, range=4, piercing=True,
            ...
            main_effect={"gfx": Transform("fire_6_1", zoom=1), "sfx": None, "duration": 2.2, "aim": {"anchor": (.5, .5), "xo": 0 ,"yo": 0}},
    ...
    BE_Action("Meteor", menu_pos=5, attributes=["magic", "fire"], effect=50, multiplier=1.2, mp_cost=70, range=4, type="all_enemies",
            ...
            main_effect={"gfx": Transform("cataclysm_sideways", xzoom=-1), "sfx": "content/sfx/sound/be/fire8.mp3", "duration": 1.8, "aim": {"point": "bc", "anchor": (.5, .1), "xo": 150, "yo": -370}, "hflip": True},
    ...
    ArealSkill("Cataclysm", menu_pos=9, attributes=["magic", "fire", "inevitable"], effect=100, multiplier=1.5, mp_cost=100, range=4, type="all_enemies", piercing=True,
            ...
            main_effect={"gfx": Transform("cataclysm_webm", zoom=.85), "sfx": "content/sfx/sound/be/fire2.mp3", "duration": 4.93, "aim": {"anchor": (.5, 1.0), "yo": 330}},
    ...
    BE_Action(u"Water", menu_pos=0, attributes=["magic", "water"], effect=10, multiplier=1.0, mp_cost=10, range=4, type="all_enemies",
            ...
            main_effect={"gfx": Transform("water_1", zoom=1.1), "sfx": "content/sfx/sound/be/water.mp3", "duration": 1.5, "aim": {"point": "bc", "anchor": (.5, 1.0), "yo": 40}, "start_at": 0},
    ...
    BE_Action(u"Watera", menu_pos=.1, attributes=["magic", "water"], effect=10, multiplier=1.1, mp_cost=8, range=4,
            ...
            attacker_effects={"gfx": "water_1", "sfx": "default"},
            main_effect={"gfx": Transform("water_2", zoom=1.4), "sfx": "content/sfx/sound/be/water.mp3", "duration": 2.0, "aim": {"point": "bc", "anchor": (.5, 1.0), "yo": 40}, "start_at": 0},
            target_sprite_damage_effect={"gfx": "true_water", "sfx": None, "initial_pause": .1, "duration": 1.4},
            target_damage_effect={"gfx": "battle_bounce", "sfx": None},
            target_death_effect={"gfx": "dissolve", "initial_pause": 1.0, "duration": .5})
    BE_Action(u"Waterga", menu_pos=.2, attributes=["magic", "water"], effect=10, multiplier=.9, mp_cost=12, range=4,
            ...
            main_effect={"gfx": Transform("water_3", zoom=1.5), "sfx": "content/sfx/sound/be/water2.mp3", "duration": 2.5, "aim": {"point": "bc", "anchor": (.5, 1.0), "yo": 40}, "start_at": 0},
    ...
    BE_Action(u"Waterja", menu_pos=.3, attributes=["magic", "water"], effect=10, multiplier=.8, mp_cost=15, range=4, type="all_enemies", piercing=True,
            ...
            attacker_effects={"gfx": "water_1", "sfx": "default"},
            main_effect={"gfx": Transform("water_4", zoom=1.5), "sfx": "content/sfx/sound/be/water3.mp3", "duration": 2.25, "aim": {"point": "bc", "anchor": (.5, 1.0), "yo": 40}, "start_at": 0},
    ...
    BE_Action(u"Last Drop", menu_pos=.5, attributes=["magic", "water"], effect=50, multiplier=1.3, mp_cost=30, piercing=True, range=6,
            ...
            main_effect={"gfx": Transform("water_6", zoom=1.9), "sfx": "content/sfx/sound/be/water5.mp3", "duration": 5.0, "aim": {"point": "bc", "anchor": (.5, 1.0), "yo": 60}},
    ...
    BE_Action(u"Geyser", menu_pos=1, attributes=["magic", "water"], effect=50, multiplier=1.4, mp_cost=50, range=6,
            ...
            attacker_effects={"gfx": "water_2", "sfx": "default"},
            main_effect={"gfx": Transform("water_5", zoom=1.9), "sfx": "content/sfx/sound/be/water6.mp3", "duration": 3.0, "aim": {"point": "bc", "anchor": (.5, 1.0), "yo": 60}, "start_at": 0},
    ...
    BE_Action(u"Heavy Rain", menu_pos=5, attributes=["magic", "water"], effect=50, multiplier=1.2, mp_cost=70, type="all_enemies", range=6,
            ...
            attacker_effects={"gfx": "water_2", "sfx": "default"},
            main_effect={"gfx": Transform("rain", zoom=2.0), "sfx": "content/sfx/sound/be/heavy_rain.mp3", "duration": 5.0, "aim": {"point": "bc", "anchor": (.5, 1.0), "yo": 80}, "hflip": True},
    ...
    BE_Action(u"Blizzard", menu_pos=0, attributes=["magic", "ice"], effect=10, multiplier=1.0, mp_cost=10, range=4, type="all_enemies",
            ...
            main_effect={"gfx": Transform("ice_1", zoom=1.9), "sfx": "content/sfx/sound/be/ice3.mp3", "duration": 2.0, "aim": {"point": "bc", "anchor": (.5, 1.0), "yo": 60}, "start_at": 0},
    ...
    BE_Action(u"Blizzara", menu_pos=.1, attributes=["magic", "ice"], effect=10, multiplier=1.1, mp_cost=8, range=4,
            ...
            attacker_effects={"gfx": "ice_1", "sfx": "default"},
            main_effect={"gfx": Transform("ice_2", zoom=1.3), "sfx": "content/sfx/sound/be/ice1.mp3", "duration": 1.5, "aim": {"point": "bc", "anchor": (.5, 1.0), "yo": 80}, "start_at": 0},
    ...
    BE_Action(u"Blizzarga", menu_pos=.2, attributes=["magic", "ice"], effect=10, multiplier=.9, mp_cost=12, range=4,
            ...
            main_effect={"gfx": Transform("ice_4", zoom=1.5), "sfx": "content/sfx/sound/be/ice2.mp3", "duration": .8, "aim": {"point": "bc", "anchor": (.5, 1.0), "yo": 40}, "start_at": 0},
    ...
    BE_Action(u"Blizzarja", menu_pos=.3, attributes=["magic", "ice"], effect=10, multiplier=.9, mp_cost=15, range=4,
            ...
            main_effect={"gfx": Transform("ice_3", zoom=1.7), "sfx": "content/sfx/sound/be/ice2.mp3", "duration": 1.25, "aim": {"point": "bc", "anchor": (.5, 1.0), "yo": 60}, "start_at": 0},
    ...
    BE_Action("Ice Blast", menu_pos=.5, attributes=["magic", "ice"], effect=50, multiplier=1.3, mp_cost=30, range=4, piercing=True, type="se",
            ...
            attacker_effects={"gfx": "orb", "sfx": "default"},
            main_effect={"gfx": Transform("ice_blast", xzoom=-1), "sfx": "content/sfx/sound/be/ice5.mp3", "duration": 2.3, "aim": {"point": "bc", "anchor": (.5, .1), "xo": 120, "yo": -370}, "hflip": True},
    ...
    BE_Action(u"Zero Prism", menu_pos=1, attributes=["magic", "ice"], effect=50, multiplier=1.4, mp_cost=50, range=4,
            ...
            attacker_effects={"gfx": "ice_2", "sfx": "default"},
            main_effect={"gfx": Transform("ice_5", zoom=2.1), "sfx": "content/sfx/sound/be/ice4.mp3", "duration": 2.1, "aim": {"point": "bc", "anchor": (.5, 1.0), "yo": 110}},
    ...
    BE_Action(u"Ice Shards", menu_pos=2, attributes=["magic", "ice"], effect=65, multiplier=1.25, mp_cost=70, range=4, type="all_enemies",
            ...
            attacker_effects={"gfx": "ice_2", "sfx": "default"},
            main_effect={"gfx": Transform("ice_6", zoom=2.0), "sfx": "content/sfx/sound/be/ice2.mp3", "duration": 1.2, "aim": {"point": "bc", "anchor": (.5, 1.0), "yo": 80}},
    ...
    BE_Action(u"Hailstorm", menu_pos=5, attributes=["magic", "ice"], effect=50, multiplier=1.35, mp_cost=60, range=4, piercing=True, type="all_enemies",
            ...
            attacker_effects={"gfx": "ice_2", "sfx": "default"},
            main_effect={"gfx": Transform("ice_7", zoom=1.7), "sfx": "content/sfx/sound/be/Hailstorm.mp3", "duration": 2.0, "aim": {"point": "bc", "anchor": (.5, 1.0), "yo": 50}, "hflip": True},
    ...
    BE_Action(u"Stone", menu_pos=0, attributes=["magic", "earth"], effect=10, multiplier=1.0, mp_cost=10, range=4, type="all_enemies",
            ...
            main_effect={"gfx": Transform("earth_1", zoom=1.4), "sfx": "content/sfx/sound/be/earth.mp3", "duration": 2.0, "aim": {"point": "bc", "anchor": (.5, 1.0), "yo": 40}, "start_at": 0},
    ...
    BE_Action(u"Stonega", menu_pos=.2, attributes=["magic", "earth"], effect=10, multiplier=.9, mp_cost=12, range=4, piercing=True,
            ...
            attacker_effects={"gfx": "earth_1", "sfx": "default"},
            main_effect={"gfx": Transform("earth_3", zoom=1.2), "sfx": "content/sfx/sound/be/earth3.mp3", "duration": 1.5, "aim": {"point": "bc", "anchor": (.5, .5), "yo": 0}, "start_at": 0},
    ...
    BE_Action(u"Stoneja", menu_pos=.3, attributes=["magic", "earth"], effect=10, multiplier=.8, mp_cost=15, range=4, piercing=True, type="all_enemies",
            ...
            attacker_effects={"gfx": "earth_1", "sfx": "default"},
            main_effect={"gfx": Transform("earth_4", zoom=1.2), "sfx": "content/sfx/sound/be/earth2.mp3", "duration": 1.2, "aim": {"point": "bc", "anchor": (.5, 1.0), "yo": 40}, "start_at": 0},
    ...
    BE_Action(u"Breach", menu_pos=.5, attributes=["magic", "earth"], effect=50, multiplier=1.3, mp_cost=30, range=4, piercing=True,
            ...
            attacker_effects={"gfx": "earth_2", "sfx": "default"},
            main_effect={"gfx": Transform("earth_5_webm", zoom=1.5), "sfx": "content/sfx/sound/be/earth4.mp3", "duration": .86, "aim": {"point": "bc", "anchor": (.5, 1.0), "yo": 0}},
            target_sprite_damage_effect={"gfx": "vertical_shake", "initial_pause": .1, "duration": .8},
    ...
    BE_Action(u"Transmutation", menu_pos=1, attributes=["magic", "earth"], effect=50, multiplier=1.4, mp_cost=50, range=4,
            ...
            attacker_effects={"gfx": "earth_2", "sfx": "default"},
            main_effect={"gfx": Transform("earth_6", zoom=1.5), "sfx": "content/sfx/sound/be/earth4.mp3", "duration": 2.0, "aim": {"point": "bc", "anchor": (.5, 1.0), "yo": 50}},
            target_sprite_damage_effect={"gfx": "shake", "initial_pause": .2, "duration": 1.8},
            target_damage_effect={"gfx": "battle_bounce", "initial_pause": .7},
    ...
    BE_Action(u"Rift Line", menu_pos=5, attributes=["magic", "earth"], effect=50, multiplier=1.2, mp_cost=65, range=4, type="all_enemies",
            ...
            attacker_effects={"gfx": "earth_2", "sfx": "default"},
            main_effect={"gfx": Transform("magma", zoom=2.0), "sfx": "content/sfx/sound/be/rift_line.mp3", "duration": 3.2, "aim": {"point": "bc", "anchor": (.5, 1.0), "yo": 75}},
    ...
    ArealSkill("Fist of Bethel", menu_pos=9, menuname="FoB", attributes=["magic", "earth", "inevitable"], effect=100, multiplier=1.5, mp_cost=100, range=4, type="all_enemies", piercing=True,
            ...
            attacker_effects={"gfx": "orb", "sfx": "default"},
            main_effect={"gfx": Transform(Transform("crushing_hand", xzoom=-1.0), zoom=2), "sfx": "content/sfx/sound/be/earth7.mp3", "duration": 2.7, "aim": {"anchor": (.5, 1.0), "xo": 0 ,"yo": 150}, "hflip": True},
            target_damage_effect={"gfx": "battle_bounce", "initial_pause": 2.7},
    ...
    BE_Action(u"Aero", menu_pos=0, attributes=["magic", "air"], effect=10, multiplier=1.0, mp_cost=10, range=4, type="all_enemies",
            ...
            main_effect={"gfx": Transform("air_1", zoom=1.2), "sfx": "content/sfx/sound/be/air2.mp3", "duration": 1.5, "aim": {"point": "center", "anchor": (.5, .5), "yo": 0}, "start_at": 0},
            target_sprite_damage_effect={"gfx": "shake", "initial_pause": .1, "duration": 1.3},
            target_damage_effect={"gfx": "battle_bounce", "sfx": None},
    ...
    BE_Action(u"Aerora", menu_pos=.1, attributes=["magic", "air"], effect=10, multiplier=1.1, mp_cost=8, range=4,
            ...
            attacker_effects={"gfx": "air_1", "sfx": "default"},
            main_effect={"gfx": Transform("air_5", zoom=1.3), "sfx": "content/sfx/sound/be/air1.mp3", "duration": .9, "aim": {"point": "center", "anchor": (.5, .5), "yo": 0}, "start_at": 0},
    ...
    BE_Action(u"Aeroga", menu_pos=.2, attributes=["magic", "air"], effect=10, multiplier=.9, mp_cost=12, range=4, piercing=True,
            ...
            main_effect={"gfx": Transform("air_2", zoom=1.2), "sfx": "content/sfx/sound/be/air3.mp3", "duration": 1.5, "aim": {"point": "center", "anchor": (.5, .5), "yo": 0}, "start_at": 0},
            target_sprite_damage_effect={"gfx": "shake", "initial_pause": .1, "duration": 1.3},
            target_damage_effect={"gfx": "battle_bounce", "sfx": None},
    ...
    BE_Action(u"Aeroja", menu_pos=.3, attributes=["magic", "air"], effect=10, multiplier=.8, mp_cost=15, range=4, piercing=True, type="all_enemies",
            ...
            attacker_effects={"gfx": "air_1", "sfx": "default"},
            main_effect={"gfx": Transform("air_3", zoom=1.4), "sfx": "content/sfx/sound/be/air2.mp3", "duration": 1.5, "aim": {"point": "center", "anchor": (.5, .5), "yo": 0}, "start_at": 0},
    ...
    BE_Action(u"Pressure", menu_pos=.5, attributes=["magic", "air"], effect=50, multiplier=1.3, mp_cost=30, range=4,piercing=True,
            ...
            main_effect={"gfx": Transform("air_4", zoom=1.2), "sfx": "content/sfx/sound/be/air3.mp3", "duration": 1.5, "aim": {"point": "center", "anchor": (.5, .5), "yo": 0}, "start_at": 0},
    ...
    BE_Action(u"Air Blast", menu_pos=1, attributes=["magic", "air"], effect=50, multiplier=1.4, mp_cost=50, range=4,
            ...
            attacker_effects={"gfx": "air_2", "sfx": "default"},
            main_effect={"gfx": Transform("air_6", zoom=1.5), "sfx": "content/sfx/sound/be/air3.mp3", "duration": 1.5, "aim": {"point": "center", "anchor": (.5, .5), "yo": 0}, "start_at": 0},
            target_sprite_damage_effect={"gfx": "shake", "initial_pause": .1, "duration": 1.3},
            target_damage_effect={"gfx": "battle_bounce", "initial_pause": 1.0},
            target_death_effect={"gfx": "dissolve", "sfx": None, "initial_pause": 1.0, "duration": .3})
    BE_Action(u"Vortex", menu_pos=2, attributes=["magic", "air"], effect=50, multiplier=1.2, mp_cost=70, range=4, type="all_enemies",
            ...
            attacker_effects={"gfx": "orb", "sfx": "default"},
            main_effect={"gfx": Transform("vortex", zoom=2.2), "sfx": "content/sfx/sound/be/vortex.mp3", "duration": 1.5, "aim": {"point": "center", "anchor": (.5, .5), "yo": 0}, "start_at": 0},
    ...
    BE_Action(u"Thunder", menu_pos=0, attributes=["magic", "electricity"], effect=10, multiplier=1.0, mp_cost=10, range=4, type="all_enemies",
            ...
            main_effect={"gfx": Transform("electricity_1", zoom=1.5), "sfx": "content/sfx/sound/be/thunder2.mp3", "duration": 1.0, "aim": {"point": "center", "anchor": (.5, .5), "yo": 0}, "start_at": 0, "hflip": True},
    ...
    BE_Action(u"Thundara", menu_pos=.1, attributes=["magic", "electricity"], effect=10, multiplier=1.1, mp_cost=8, range=4,
            ...
            attacker_effects={"gfx": "electricity_1", "sfx": "default"},
            main_effect={"gfx": Transform("electricity_2", zoom=1.7), "sfx": "content/sfx/sound/be/thunder4.mp3", "duration": 1.2, "aim": {"point": "bc", "anchor": (.5, 1.0), "yo": 50}, "start_at": 0},
    ...
    BE_Action(u"Thundaga", menu_pos=.2, attributes=["magic", "electricity"], effect=10, multiplier=.9, mp_cost=12, range=4,
            ...
            main_effect={"gfx": Transform("electricity_4", zoom=1.8), "sfx": "content/sfx/sound/be/thunder3.mp3", "duration": .6, "aim": {"point": "center", "anchor": (.5, .5), "yo": 0}, "start_at": 0},
    ...
    BE_Action(u"Thundaja", menu_pos=.3, attributes=["magic", "electricity"], effect=10, multiplier=.8, mp_cost=15, range=4,
            ...
            main_effect={"gfx": Transform("electricity_3", zoom=2.2), "sfx": "content/sfx/sound/be/thunder.mp3", "duration": 1.35, "aim": {"point": "bc", "anchor": (.5, 1.0), "yo": 50}, "start_at": 0, "hflip": True},
    ...
    BE_Action(u"Electromagnetism", menu_pos=1, attributes=["magic", "electricity"], menuname="EM", effect=50, multiplier=1.4, mp_cost=50, range=4,
            ...
            main_effect={"gfx": Transform("electricity_6", zoom=1.8), "sfx": "content/sfx/sound/be/thunder6.mp3", "duration": 3.2, "aim": {"point": "tc", "anchor": (.5, .5), "yo": 15}, "start_at": 0, "hflip": True},
    ...
    BE_Action(u"Thunderstorm", menu_pos=2, attributes=["magic", "electricity"], menuname="TStorm", effect=50, multiplier=1.2, mp_cost=70, range=4,
            ...
            main_effect={"gfx": Transform("electricity_5", zoom=1.6), "sfx": "content/sfx/sound/be/thunder5.mp3", "duration": 1.6, "aim": {"point": "tc", "anchor": (.5, .5), "yo": 0}, "start_at": 0},
    ...
    P2P_ArealSkill(u"Ion Storm", menu_pos=5, attributes=["magic", "electricity"], effect=50, multiplier=1.1, mp_cost=60, range=4, piercing=True, type="all_enemies",
            ...
            projectile_effects={"gfx": "ion_1", "sfx": "content/sfx/sound/be/ion_storm.mp3", "duration": 1.0},
            main_effect={"gfx": Transform("ion", zoom=2.0), "sfx": None, "duration": 2.25, "aim": {"anchor": (.5, .5), "xo": 0 ,"yo": 0}},
            attacker_effects={"gfx": "orb", "sfx": "default"},
            # target_damage_effect={"gfx": "battle_bounce", "initial_pause": .3, "duration": 2.5},
            target_sprite_damage_effect={"gfx": "on_ele_with_shake", "initial_pause": .3, "duration": 1.4},
            target_death_effect={"gfx": "hide", "initial_pause": .7, "duration": .01},
    ...
    BE_Action("Full Discharge", menuname="F Discharge", menu_pos=4.3, attributes=["magic", "electricity", "water"], effect=75, multiplier=1.35, mp_cost=80, range=4, piercing=True, true_pierce=True,
            ...
            attacker_effects={"gfx": "orb", "sfx": "default"},
            main_effect={"gfx": Transform("thunder_storm_2", xzoom=1.2, yzoom=1.3), "start_at": 0, "sfx": "content/sfx/sound/be/thunder5.mp3", "duration": 1.6, "aim": {"point": "bc", "anchor": (.5, 1.0), "xo": 0 ,"yo": 30}},
            target_damage_effect={"gfx": "battle_bounce", "initial_pause": 1.5},
    ...
    ArealSkill("Thunderstorm Front", menu_pos=9, menuname="T Front", attributes=["magic", "electricity", "inevitable"], effect=100, multiplier=1.5, mp_cost=100, range=4, type="all_enemies", piercing=True, tier=4,
            ...
            attacker_effects={"gfx": "orb", "sfx": "default"},
            main_effect={"gfx": Transform("moz_stretch", zoom=.7), "sfx": "content/sfx/sound/be/thunder7.mp3", "duration": 3.4, "aim": {"anchor": (.5, 1.0), "yo": 150}},
    ...
    BE_Action(u"Holy", menu_pos=0, attributes=["magic", "light"], effect=15, multiplier=1.0, mp_cost=12, range=4, type="all_enemies",
            ...
            main_effect={"gfx": Transform("light_1", zoom=1.5), "sfx": "content/sfx/sound/be/light1.mp3", "duration": 1.25, "aim": {"point": "center", "anchor": (.5, .5), "yo": 0}, "start_at": 0},
    ...
    BE_Action(u"Holyra", menu_pos=.1, attributes=["magic", "light"], effect=15, multiplier=1.1, mp_cost=10, range=4,
            ...
            attacker_effects={"gfx": "light_1", "sfx": "default"},
            main_effect={"gfx": Transform("light_2", zoom=1.5), "sfx": "content/sfx/sound/be/light3.mp3", "duration": 1.25, "aim": {"point": "center", "anchor": (.5, .5), "yo": 0}, "start_at": 0},
            target_sprite_damage_effect={"gfx": "on_light_with_shake", "initial_pause": .1, "duration": 1.1},
            target_damage_effect={"gfx": "battle_bounce", "sfx": None},
            target_death_effect={"gfx": "dissolve", "sfx": None, "initial_pause":0.9, "duration": .2})
    BE_Action(u"Holyda", menu_pos=.2, attributes=["magic", "light"], effect=15, multiplier=.9, mp_cost=14, range=4,
            ...
            main_effect={"gfx": Transform("light_3", zoom=2.5), "sfx": "content/sfx/sound/be/light4.mp3", "duration": 1.6, "aim": {"point": "center", "anchor": (.5, .5), "yo": 0}, "start_at": 0},
    ...
    BE_Action(u"Holyja", menu_pos=.3, attributes=["magic", "light"], effect=15, multiplier=.8, mp_cost=17, range=4, piercing=True, type="all_enemies",
            ...
            attacker_effects={"gfx": "light_1", "sfx": "default"},
            main_effect={"gfx": Transform("light_4_webm", zoom=1.5), "sfx": "content/sfx/sound/be/light5.mp3", "duration": 2.23, "aim": {"point": "bc", "anchor": (.5, 1.0), "yo": 70}},
    ...
    BE_Action(u"Star Light", menu_pos=.5, attributes=["magic", "light"], effect=60, multiplier=1.3, mp_cost=35, range=4,
            ...
            main_effect={"gfx": Transform("light_6_webm", zoom=1.4), "sfx": "content/sfx/sound/be/light2.mp3", "duration": .96, "aim": {"point": "center", "anchor": (.5, .5), "yo": 0}, "start_at": 0},
    ...
    BE_Action(u"Photon Blade", menu_pos=1, attributes=["magic", "light"], effect=60, multiplier=1.4, mp_cost=55, range=4,
            ...
            attacker_effects={"gfx": "light_2", "sfx": "default"},
            main_effect={"gfx": Transform("light_5", zoom=1.9), "sfx": "content/sfx/sound/be/dawn.mp3", "duration": 2.5, "aim": {"point": "center", "anchor": (.5, .5), "yo": 0}, "start_at": 0, "hflip": True},
    ...
    BE_Action("Forced Dawn", menu_pos=5, menuname="Dawn", attributes=["magic", "light"], effect=60, multiplier=1.2, mp_cost=75, range=4, type="all_enemies",
            ...
            attacker_effects={"gfx": "orb", "sfx": "default"},
            main_effect={"gfx": Transform("dawn", zoom=2.5), "sfx": "content/sfx/sound/be/dawn.mp3", "duration": 3.3, "aim": {"point": "bc", "anchor": (.5, 1.0), "yo": 50, "xo": -50}},
            target_damage_effect={"gfx": "battle_bounce", "initial_pause": 1.7},
    ...
    ArealSkill("Holy Blast", menu_pos=9, attributes=["magic", "light", "inevitable"], effect=120, multiplier=1.5, mp_cost=110, range=4, type="all_enemies", piercing=True,
            ...
            attacker_effects={"gfx": "orb", "sfx": "default"},
            main_effect={"gfx": Transform("holy_blast", zoom=2.2), "sfx": "content/sfx/sound/be/light6.mp3", "duration": 3.7, "aim": {"anchor": (.5, 1.0), "yo": 320}},
    ...
    BE_Action(u"Dark", menu_pos=0, attributes=["magic", "darkness"], effect=15, multiplier=1.0, mp_cost=12, range=4, type="all_enemies",
            ...
            main_effect={"gfx": Transform("darkness_1", zoom=1.3), "sfx": "content/sfx/sound/be/darkness1.mp3",
                        "duration": 1.0, "aim": {"point": "center", "anchor": (.5, .5), "yo": 0}, "start_at": 0},
    ...
    BE_Action(u"Darkra", menu_pos=.1, attributes=["magic", "darkness"], effect=15, multiplier=1.1, mp_cost=10, range=4,
            ...
            main_effect={"gfx": Transform("darkness_2", zoom=1.6), "sfx": "content/sfx/sound/be/darkness2.mp3",
                         "duration": 1.6, "aim": {"point": "center", "anchor": (.5, .5), "yo": 0}, "start_at": 0},
    ...
    BE_Action(u"Darkga", menu_pos=.2, attributes=["magic", "darkness"], effect=15, multiplier=.9, mp_cost=14, range=4, piercing=True,
            ...
            main_effect={"gfx": Transform("darkness_3", zoom=1.4), "sfx": "content/sfx/sound/be/darkness3.mp3",
                         "duration": 1.5, "aim": {"point": "center", "anchor": (.5, .5)}},
    ...
    BE_Action(u"Eternal Gluttony", menu_pos=.5, attributes=["magic", "darkness"], effect=60, multiplier=1.3, mp_cost=35, range=4, piercing=True,
            ...
            main_effect={"gfx": Transform("darkness_5", zoom=1.2), "sfx": "content/sfx/sound/be/horny2.mp3",
                         "duration": 1.2, "aim": {"point": "center", "anchor": (.5, .5)}},
    ...
    BE_Action(u"Black Hole", menu_pos=1, attributes=["magic", "darkness"], effect=60, multiplier=1.2, mp_cost=75, range=4, type="all_enemies",
            ...
            attacker_effects={"gfx": "dark_2", "sfx": "default"},
            main_effect={"gfx": Transform("darkness_6", zoom=1.1), "sfx": "content/sfx/sound/be/darkness3.mp3", "duration": 1.5, "aim": {"point": "center", "anchor": (.5, .5)}},
            target_damage_effect={"gfx": "battle_bounce", "initial_pause": .1},
    ...
    BE_Action("Other Light", menu_pos=4, attributes=["magic", "darkness", "light"], effect=75, multiplier=1.25, mp_cost=45, range=4, piercing=True, true_pierce=True,
            ...
            attacker_effects={"gfx": "orb", "sfx": "default"},
            main_effect={"gfx": Transform("darklight", zoom=1.5), "sfx": "content/sfx/sound/be/darklight.mp3", "duration": 2.0, "aim": {"point": "tc", "anchor": (.5, 0), "yo": -55}},
    ...
    BasicHealingSpell(u"Life Wind", menu_pos=-3, attributes=["magic", "healing", "air"], kind="healing", effect=.1, mp_cost=10, range=5, type="all_allies",
            ...
            main_effect={"gfx": Transform("heal_3", zoom=1.4), "sfx": "content/sfx/sound/be/heal3.mp3", "duration": 2.1, "aim": {"point": "center", "anchor": (.5, .5), "yo": 0}},
    ...
    BasicHealingSpell(u"Restoration", menu_pos=-1, attributes=["magic", "healing", "light"], kind="healing", effect=.5, mp_cost=40, range=5, type="sa", piercing=True, true_pierce=True,
            ...
            attacker_action={"gfx": None},
            attacker_effects={"gfx": "runes_1", "sfx": "default"},
            main_effect={"gfx": Transform("heal_1", zoom=2.0), "sfx": "content/sfx/sound/be/heal1.mp3", "duration": 3.0, "aim": {"point": "bc", "anchor": (.5, 1.0), "yo": 40}},
            target_sprite_damage_effect={"gfx": "being_healed"},
            target_damage_effect={"gfx": "battle_bounce", "initial_pause": 1.0},
            target_death_effect={"gfx": "dissolve", "initial_pause": 1.5, "duration": 1.5})
    ...
    ReviveSpell(u"Revive", attributes=["magic", "light"], kind="revival", menu_pos=-1,
            ...
            main_effect={"gfx": Transform("resurrection", zoom=1.75), "sfx": "content/sfx/sound/be/heal2.mp3",
                         "duration": 2.0, "aim": {"point": "center", "anchor": (.5, .5), "yo": -150}},
            target_sprite_damage_effect={"gfx": None},
...
##### Effects:
    ...
    DefenceBuffSpell("Aery Shield", menu_pos=-1, attributes=["status", "air"],
                     ...
                     target_damage_effect={"gfx": None},
                     target_death_effect={"gfx": None})
    DefenceBuffSpell("Arcane Field", menu_pos=-1, attributes=["status", "darkness"], kind="buff", defence_multiplier={"magic": 1.5}, buff_group="spell shield", buff_icon=ProportionalScale("content/gfx/be/buffs/mag_def.png", 30, 30), mp_cost=.1, vitality_cost=.1, range=4, type="sa",
            ...
            target_damage_effect={"gfx": None},
            target_death_effect={"gfx": None})
    DefenceBuffSpell("Arcane Shield", menu_pos=-1, attributes=["status", "darkness"], kind="buff", defence_multiplier={"magic": 3.0}, buff_group="spell shield", vitality_cost=.2, mp_cost=.2, buff_icon=ProportionalScale("content/gfx/be/buffs/big_mag_def.png", 30, 30), range=4, type="sa",
            desc="Sets up a powerful force field, shielding from magical damage.", tier=2,
            main_effect={"gfx": Transform("magic_shield_webm", zoom=1.1), "sfx": "content/sfx/sound/be/m_shield.ogg", "duration": 1.27, "aim": {"point": "center", "anchor": (.5, .5), "yo": 0}},
            target_sprite_damage_effect={"gfx": None},
            target_damage_effect={"gfx": None},
            target_death_effect={"gfx": None})
    DefenceBuffSpell("Solid Field", menu_pos=-1, attributes=["status", "earth"], kind="buff", defence_multiplier={"melee": 1.5}, buff_group="melee shield", buff_icon=ProportionalScale("content/gfx/be/buffs/melee_def.png", 30, 30), mp_cost=.1, vitality_cost=.1, range=4, type="sa", defence_gfx="solid_shield",
            ...
            target_damage_effect={"gfx": None},
            target_death_effect={"gfx": None})
    DefenceBuffSpell("Solid Shield", menu_pos=-1, attributes=["status", "earth"], kind="buff", defence_multiplier={"melee": 3.0}, buff_group="melee shield", vitality_cost=.2, mp_cost=.2, buff_icon=ProportionalScale("content/gfx/be/buffs/big_melee_def.png", 30, 30), range=4, type="sa", defence_gfx="solid_shield",
    ...
    DefenceBuffSpell("Gray Shield", menu_pos=-1, attributes=["status", "darkness", "light"], kind="buff",
            ...
            vitality_cost=.25, mp_cost=.25, buff_icon=ProportionalScale("content/gfx/be/buffs/gray.png", 30, 30),
