...
label load_battle_skills:
    python:
        ...
        BE_Action(u"Power Bear", menu_pos=-3, range=1, attributes=["melee", "light", "physical"], effect=100, critpower=.1, multiplier=1.4, vitality_cost=20, piercing=True,
                desc="A spirit of ancient long dead bear assist in battle, attacking the target from the spirits world.",
                attacker_effects={"gfx": "bear", "sfx": "content/sfx/sound/be/wolf_1.ogg", "hflip": True},
