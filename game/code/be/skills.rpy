...
python: # Bow Attacks:
    ...
    ArrowsSkill(u"Fire Arrow", menu_pos=1.2, attributes=["ranged", "fire", "air"], true_pierce=True,
            ...
            attacker_effects={"gfx": "default_1", "sfx": "default", "zoom": 1.6, "duration": 1.12},
...
python: ##### Mobs-only attacks:
    ...
    BE_Action(u"Power Pack", menu_pos=3, range=1, attributes=["melee", "light", "physical"],
            ...
            mob_only=True,
            attacker_effects={"gfx": "wolf", "sfx": "content/sfx/sound/be/wolf_1.ogg", "hflip": True, "zoom": .85, "duration": 1.27},
    ...
    BE_Action(u"Power Bear", menu_pos=3, range=1, attributes=["melee", "ice", "physical"],
            ...
            mob_only=True,
            attacker_effects={"gfx": "bear", "sfx": "content/sfx/sound/be/bear.mp3", "hflip": True, "zoom": .85, "duration": 0.97},
...
python: # Fire:
    BE_Action(u"Fire", menu_pos=0, attributes=["magic", "fire"], effect=10, multiplier=1.0, type="all_enemies", mp_cost=10, range=4,
            ...
            attacker_effects={"gfx": "fire_1", "sfx": "default", "zoom": 1.5, "duration": 0.84},
    ...
    BE_Action(u"Firaga", menu_pos=.2, attributes=["magic", "fire"], effect=10, multiplier=.9, mp_cost=12, range=4, piercing=True,
            ...
            attacker_effects={"gfx": "fire_1", "sfx": "default", "zoom": 1.5, "duration": 0.84}, tier=0,
...
python: # Water:
    BE_Action(u"Water", menu_pos=0, attributes=["magic", "water"], effect=10, multiplier=1.0, mp_cost=10, range=4, type="all_enemies",
            ...
            attacker_effects={"gfx": "water_1", "sfx": "default", "zoom": 1.5, "duration": 0.84},
    ...
    BE_Action(u"Waterga", menu_pos=.2, attributes=["magic", "water"], effect=10, multiplier=.9, mp_cost=12, range=4,
            ...
            attacker_effects={"gfx": "water_1", "sfx": "default", "zoom": 1.5, "duration": 0.84}, tier=0,
...
python: # Ice:
    BE_Action(u"Blizzard", menu_pos=0, attributes=["magic", "ice"], effect=10, multiplier=1.0, mp_cost=10, range=4, type="all_enemies",
            ...
            attacker_effects={"gfx": "ice_1", "sfx": "default", "zoom": 1.5, "duration": 0.84},
    ...
    BE_Action(u"Blizzarga", menu_pos=.2, attributes=["magic", "ice"], effect=10, multiplier=.9, mp_cost=12, range=4,
            ...
            attacker_effects={"gfx": "ice_1", "sfx": "default", "zoom": 1.5, "duration": 0.84}, piercing=True,
    ...
    BE_Action(u"Blizzarja", menu_pos=.3, attributes=["magic", "ice"], effect=10, multiplier=.9, mp_cost=15, range=4,
            ...
            attacker_effects={"gfx": "ice_1", "sfx": "default", "zoom": 1.5, "duration": 0.84}, piercing=True, type="all_enemies",
...
python: # Earth:
    BE_Action(u"Stone", menu_pos=0, attributes=["magic", "earth"], effect=10, multiplier=1.0, mp_cost=10, range=4, type="all_enemies",
            ...
            attacker_effects={"gfx": "earth_1", "sfx": "default", "zoom": 1.5, "duration": 0.84},
...
python: # Air:
    BE_Action(u"Aero", menu_pos=0, attributes=["magic", "air"], effect=10, multiplier=1.0, mp_cost=10, range=4, type="all_enemies",
            ...
            attacker_effects={"gfx": "air_1", "sfx": "default", "zoom": 1.5, "duration": 0.84},
    ...
    BE_Action(u"Aeroga", menu_pos=.2, attributes=["magic", "air"], effect=10, multiplier=.9, mp_cost=12, range=4, piercing=True,
            ...
            attacker_effects={"gfx": "air_1", "sfx": "default", "zoom": 1.5, "duration": 0.84}, tier=0,
...
python: # Electricity:
    BE_Action(u"Thunder", menu_pos=0, attributes=["magic", "electricity"], effect=10, multiplier=1.0, mp_cost=10, range=4, type="all_enemies",
            ...
            attacker_effects={"gfx": "electricity_1", "sfx": "default", "zoom": 1.5, "duration": 0.84},
    ...
    BE_Action(u"Thundaga", menu_pos=.2, attributes=["magic", "electricity"], effect=10, multiplier=.9, mp_cost=12, range=4,
            ...
            attacker_effects={"gfx": "electricity_1", "sfx": "default", "zoom": 1.5, "duration": 0.84}, piercing=True,
    ...
    BE_Action(u"Thundaja", menu_pos=.3, attributes=["magic", "electricity"], effect=10, multiplier=.8, mp_cost=15, range=4,
            ...
            attacker_effects={"gfx": "electricity_1", "sfx": "default", "zoom": 1.5, "duration": 0.84}, piercing=True, type="all_enemies",
...
python: # Light:
    BE_Action(u"Holy", menu_pos=0, attributes=["magic", "light"], effect=15, multiplier=1.0, mp_cost=12, range=4, type="all_enemies",
            ...
            attacker_effects={"gfx": "light_1", "sfx": "default", "zoom": 1.5, "duration": 0.84},
    ...
    BE_Action(u"Holyda", menu_pos=.2, attributes=["magic", "light"], effect=15, multiplier=.9, mp_cost=14, range=4,
            ...
            attacker_effects={"gfx": "light_1", "sfx": "default", "zoom": 1.5, "duration": 0.84}, piercing=True,
...
python: # Darkness:
    BE_Action(u"Dark", menu_pos=0, attributes=["magic", "darkness"], effect=15, multiplier=1.0, mp_cost=12, range=4, type="all_enemies",
            ...
            attacker_effects={"gfx": "dark_1", "sfx": "default", "zoom": 1.5, "duration": 0.84},
...
python: # Healing:
    ...
    BasicHealingSpell(u"Life Wind", menu_pos=-3, attributes=["magic", "healing", "air"], kind="healing", effect=.1, mp_cost=10, range=5, type="all_allies",
            ...
            attacker_effects={"gfx": "runes_1", "sfx": "default", "zoom": 1.1, "duration": 0.75},
...
python: # Reviving:
    ReviveSpell(u"Revive", attributes=["magic", "light"], kind="revival", menu_pos=-1,
            ...
            attacker_action={"gfx": None},
            attacker_effects={"gfx": "circle_3", "sfx": "default", "zoom": 1.8, "duration": 0.96},
