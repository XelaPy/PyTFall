    ...
    class StripJob(Job):
        ...
        def traits_and_effects_effectiveness_mod(self, worker, log):
            ...
            if locked_dice(65): # traits don't always work, even with high amount of traits there are normal days when performance is not affected
                ...
                traits = list(i for i in worker.traits if i in ["Abnormally Large Boobs", "Small Boobs", "Scars", "Not Human", "Flat Ass", "Exhibitionist", "Sexy Air", "Clumsy", "Flexible", "Psychic", "Manly", "Artificial Body", "Lesbian", "Shy", "Aggressive", "Big Boobs", "Great Arse", "Long Legs", "Strange Eyes", "Natural Follower"])
                if traits:
