    ...
    class BarJob(Job):
        ...
        def traits_and_effects_effectiveness_mod(self, worker, log):
            ...
            if locked_dice(65): # traits don't always work, even with high amount of traits there are normal days when performance is not affected
                ...
                traits = list(i for i in worker.traits if i in ["Great Arse", "Bad Eyesight", "Curious", "Indifferent", "Neat", "Messy", "Heavy Drinker", "Ill-mannered", "Psychic", "Shy", "Nerd", "Natural Follower", "Virtuous", "Natural Leader", "Clumsy", "Stupid", "Abnormally Large Boobs", "Big Boobs", "Scars", "Manly", "Vicious"])
