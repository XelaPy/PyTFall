init -11 python:
    ...
    def pick_chars_profile_tags(char):
        # Used for chars_profile and personal ND.
        tags = []
        exclude = []
        ...
        if "Slime" in char.traits:
            ...
            tags = ['profile']
            exclude = ["nude", "revealing", "lingerie", "swimsuit"]
        return tags, exclude
    ...
    def change_char_in_profile(dir="next"):
        ...
        # Set image:
        tags, exclude = pick_chars_profile_tags(char)
