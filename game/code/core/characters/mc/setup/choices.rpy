init:
    ...
    python hide: # Warrior options:
        ...
        harpy["text"] += set_font_color("\n+ Harpy Priestess Blood Trait", "green")
        ...
        temp["text"] += set_font_color("\n+ Effective Metabolism Trait", "green")
        ...
        temp["text"] += set_font_color("\n+ Amazon Musculature Trait", "green")
        ...
        temp["text"] += set_font_color("\n+ Fire Dragon Scales Trait", "green")
        ...
        temp["text"] += set_font_color("\n+ Stone Dragon Scales Trait", "green")
