screen pyp_battle_engine():
    ...
    fixed:
        ...
        vbox:
            ...
            null height 5
            text "Slaves have a special place in the combat. The laws of the city forbid them to fight, so while they can be taken into battle, they cannot attack anyone nor use spells."
            null height 5
...
screen pyp_attacks():
    ...
    fixed:
        ...
        vbox:
            ...
            label "Attacks"
            text "Each character has one (sometimes more) basic attack when unarmed. Other than that, the primary way to get more attacks is to equip a weapon. Each weapon has its own set of attacks, usually unique. The attacks will be available as long as the weapon is equipped. However, the default unarmed attack becomes unavailable if you have a weapon in hand."
            null height 5
...
screen pyp_escape():
    ...
    fixed:
        ...
        vbox:
            ...
            text "If your fight doesn't go well, you can escape it. The escape is always successful, but it counts as losing regarding rewards. During arena fights and duels, it's replaced by surrender, but it has the same function."
            null height 5
