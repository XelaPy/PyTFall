...
init python:
    ...
    pyp.add_main("B&B", "pyp_buildings_and_businesses")
    pyp.add_sub("Buildings", "pyp_buildings", "B&B")
    pyp.add_sub("Businesses", "pyp_businesses", "B&B")
    pyp.add_sub("Clients", "pyp_clients", "B&B")
    pyp.add_sub("Building Stats", "pyp_building_stats", "B&B")
    pyp.add_sub("Advertising", "pyp_advertising", "B&B")
    pyp.add_sub("Management", "pyp_manager", "B&B")
    pyp.add_sub("Controls", "pyp_buildings_controls", "B&B")
    pyp.add_sub("Workers", "pyp_workers", "B&B")
    pyp.add_sub("Jobs", "pyp_jobs", "B&B")
    pyp.add_sub("Simulation", "pyp_simulation", "B&B")

    pyp.add_main("School", "pyp_school")

    pyp.add_main("Q&E", "pyp_quests_and_events")
    pyp.add_sub("Quests", "pyp_quests", "Q&E")
    pyp.add_sub("Events", "pyp_events", "Q&E")
