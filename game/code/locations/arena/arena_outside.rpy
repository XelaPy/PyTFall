    ...
    while loop:
        menu:
            ...
            "Tell me about Arena":
                ...
                ax "The arena is divided in two sections, one for the {color=[green]}matches{/color} and one for {color=[green]}dogfights{/color}."
            ...
            "Buy the Arena Permit?" if not hero.arena_permit and heard_about_arena:
                if hero.arena_rep >=5000:
                    ax "Looks like you've managed to gain enough reputation. Congratulations!"
                    menu:
            ...
            "Official matches and ladders?" if heard_about_arena:
                ...
                ax "It's a great honour to be listed in any of the ladders. If you have the skills and tools required you should definitely give it a go."
                ax "These types of matches are scheduled in advance. The loser goes down one position and the winner gains a position."
                ax "As you've probably figured out, you can loose your place in the ladder without actually losing a fight."
            ...
            "How does team combat work?" if heard_about_arena:
                ...
                ax "Obviously there is duelling as well. Good one on one fights are also adored by the spectators!"
