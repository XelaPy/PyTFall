    ...
    if gm.show_girls:
        ...
        for entry in gm.display_girls():
            hbox:
                ...
                use rg_lightbutton(img=entry.show(*tags, exclude=["urban", "wildness", "suburb", "nature", "winter", "night", "formal", "indoor", "indoors"], type="first_default", label_cache=True, resize=(300, 400), gm_mode=True),
