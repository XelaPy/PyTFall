...
label slavel_market_controls:
    ...
    python:
        ...
        if pytfall.world_actions.location("slave_market"):
            ...
            pytfall.world_actions.work(Iff(global_flag_complex("visited_sm")), index="work_all", name="Work for the rest of the day", returned="mc_action_work_in_slavemarket_all_day")
